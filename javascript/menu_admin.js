...
var _cmSplit;
		...
		[
			...
			_cmSplit,
				...
				['<img src="http://'+dir+'/IPCuba/imagenes/extrasmall/agt_stop.gif" />','Establecimientos negados','http://'+dir+'/IPCuba/captaciones/listados/inc_E4.php',null,'Listados de establecimientos negados a brindar información.'],],
			...
			[null,'Cálculos',null,null,'Cálculos de imputaciones, relativos e índices',
				...
				['<img src="http://'+dir+'/IPCuba/imagenes/extrasmall/db_comit.gif" />','Por Mercado','http://'+dir+'/IPCuba/indices/x_mer/l_calculo.php',null,'Cálculo de índices por mercado.', 
				 
				 
					['<img src="http://'+dir+'/IPCuba/imagenes/extrasmall/up.gif" />','Nivel de variedad en cada municipio','http://'+dir+'/IPCuba/indices/x_mer/l_var_x_dpa.php', null,'Cálculo de índices a nivel de variedad en cada municipio usando media geométrica por mercado.'],
					['<img src="http://'+dir+'/IPCuba/imagenes/extrasmall/up.gif" />','Nivel de artículo en cada municipio','http://'+dir+'/IPCuba/indices/x_mer/cal_indice_nivel_art_x_dpa_x_mer.php', null,'Cálculo de índices a nivel de artículo en cada municipio usando media geométrica por mercado.'],
					
					_cmSplit,
					
					['<img src="http://'+dir+'/IPCuba/imagenes/extrasmall/up.gif" />','Nivel de artículo nacional','http://'+dir+'/IPCuba/indices/x_mer/cal_indice_nivel_art_x_mer.php', null,'Cálculo de índices a nivel de artículo nacional usando media geométrica por mercado.'],
					
					['<img src="http://'+dir+'/IPCuba/imagenes/extrasmall/up.gif" />','Niveles superiores','http://'+dir+'/IPCuba/indices/x_mer/cal_indice_nivel_sup_x_mer.php', null,'Cálculo de índices a niveles superiores nacional usando media aritmética ponderada por mercado.'],
