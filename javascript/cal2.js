...
// +------------------------------------------------------------+
// |       Derechos Reservados 2002  Xin Yang   All Rights Reserved.
...
// codes
var calWidth=200, calHeight=200, calOffsetX=-200, calOffsetY=16//16;
var calWin=null;
var winX=0, winY=0;
var cal="cal";
var cals=new Array();
...
function showCal(name) {
  ...
  if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
   ...
   // document.onclick=
    ...
    if (!hasCal) {
      if (isIE || isOpera6) {
        calWin=window.open("","cal","toolbar=0,width="+calWidth+",height="+calHeight+",left="+(winX+calOffsetX)+",top="+(calOffsetY));
      }
      else {
