...
$strXML = "<graph caption='Índice de Precios al Consumidor' subcaption='' hovercapbg='FFECAA' hovercapborder='F47E00' formatNumberScale='0' decimalPrecision='2' showvalues='1' numdivlines='3' numVdivlines='0' yaxisminvalue='".$min."' yaxismaxvalue='".$max."'  rotateNames='1'>";
