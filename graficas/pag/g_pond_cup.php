...
$sql_cap = "select distinct idb_division, fecha, cod_division, division, mercado_nuevo, b_division.r_peso from n_division, b_division, n_mercado where b_division.id_division=n_division.id_division and b_division.id_mercado_nuevo=n_mercado.id_mercado_nuevo and n_mercado.id_mercado_nuevo='1' and fecha='".$fecha_max."' order by cod_division desc";	
//print 	$sql_cap;
...
<tr> 
                    <td height="56" align="right" class="menudottedline"><table width="99%" border="0" class="menubar"  id="toolbar">
                      <tr >
                        ...
                        <td width="93%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Ponderaciones de divisi&oacute;n en CUP.</font></strong></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
