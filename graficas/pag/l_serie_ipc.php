...
if ($_GET["sel_ano2"]!="") $sel_ano2 = $_GET['sel_ano2'];
if (isset($_POST["sel_ano2"])) $sel_ano2 = $_POST['sel_ano2'];
...
<tr> 
                    <td height="56" align="right" class="menudottedline"><table width="99%" border="0" class="menubar"  id="toolbar">
                      <tr >
                        ...
                        <td width="85%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Serie del &iacute;ndice de precios al comsumidor.</font></strong></td>
                        <td width="8%"><div align="center"> <a class="toolbar" href="g_serie_ipc.php?dia1=<?php print $sel_ano."-01-01";?>&dia2=<?php print $sel_ano2."-12-31";?>"  ><img name="ver" src="../../imagenes/admin/html_f2.png" alt="Ver formularios" width="32" height="32" border="0">
                          Gráfica</a> </div></td>
                      </tr>
                    </table></td>
                  </tr>
                ...
                <table  class="tabla" width="38%" align="center">
                  ...
                  <tr>
                    <td width="31%" height="20" align="right">Entre:</td>
                    <td width="32%" align="center"><div align="left">
                    ...
                    <td width="37%" align="center"><div align="left">
                      <select name="sel_ano2" id="sel_ano2" onChange="javascript:document.frm.submit();">
                        <option value="0">------</option>
                        <?php 
						  $anno2=date("Y");
						  for($i=4;$i>=0;$i--){
							  ...
							  ?>
                        <option <?php if($sel_ano2==$anno2-$i)print "selected";?>><?php print $anno2-$i;?></option>
                        <?php }}?>
                      </select>
                    </div></td>
                  </tr>
