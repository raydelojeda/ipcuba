...
//print $mes_actual;
$query = "select fecha_cal,fecha_desuso, fecha_modif, n_var_estab.fecha_captar,captacion.id_var_estab,id_cap, variedad, obs,cod_var,ecod_var,  n_variedad.id_variedad, id_estab_sustituido,fecha_sus,
cap_uni, tipologia,
cod_estab,dir,n_estab.cod_dpa,cod_dpa_nueva,prov_mun_nuevo, estab, prov_mun, inc,captacion.id_inc,cant,
...
<div align="center"> <a  onClick="modif('m_datos.php');" class="toolbar" href="#"> 
                              ...
                              <br>
                              Editar</a> </div></td>
                          <?php if($rol=="admin" || $rol=="edito" || $rol=="super") {?>
                          <td > 
...
<tr> 
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="20" class="intro" ><a href="l_datos_m.php?order=<?php echo "fecha_desuso";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">-</a></td>
                    <td width="22" class="intro" ><a href="l_datos_m.php?order=<?php echo "fecha".", ".$order ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">-</a></td>
                    <td width="22" class="intro" ><a href="l_datos_m.php?order=<?php echo "mercado";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">M</a></td>
                    <td width="28" class="intro" ><a href="l_datos_m.php?order=<?php echo "obs";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">I/O</a></td>
                    <td width="201" class="intro" ><a href="l_datos_m.php?order=<?php echo  "variedad";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Variedad</a></td>
                    <td width="190" class="intro" ><a href="l_datos_m.php?order=<?php echo "estab";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Establecimiento</a></td>
                    <td width="72" class="intro" ><div align="right"><a href="l_datos_m.php?order=<?php echo "captacion.precio";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Precio</a></div></td>
                    <?php if($rol!="autor") {?> <td width="64" class="intro" ><a href="l_datos_m.php?order=<?php echo "cod_dpa";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Cod DPA</a></td>
                    <?php }?>
                    <td width="52" class="intro" ><a href="l_datos_m.php?order=<?php echo "usuario";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Usuario</a></td>
                    <td width="41" class="intro" ><a href="l_datos_m.php?order=<?php echo "fecha_captar";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Fecha
                        </a></td>
                    <td width="21" class="intro" >
                      <?php if($rol=="admin" || $rol=="super") {?> <input name="checkbox" onClick="marcar();" type="checkbox">
                   <?php }else print "&nbsp;";?> </td>
                  </tr>
                  <?php
if($rs->fields[0]!='')
  ...
  ?>
                  <tr  height="50" <?php $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";?>> 
                    ...
                    <td  class="raya" align="center"><?php if($rs->fields["fecha_desuso"]){?>
                      <a onMouseOver="return overlib('<?php echo "Variedad dada de baja en el establecimiento el día ".$rs->fields["fecha_desuso"].".";?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1"href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>"><p><img border="0" src="../../imagenes/extrasmall/deletecell.gif"></p></a>
					...
					?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php echo $rs->fields["estab"];?></a></td>
                    <td align="right"  class="raya"><a onMouseOver="return overlib('<?php echo "<b> UM: </b>".$rs->fields["cant"]." ".$rs->fields["cap_uni"];if($cont_imp)print "<br><b>Precio imputado</b>";?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php echo number_format($rs->fields["precio"], 2, ',', ' ');?></a></td>
                     
					 <?php if($rol!="autor") {?>
                     <td class="raya"align="center"><a onMouseOver="return overlib('<?php echo "DPA: ".$rs->fields["prov_mun_nuevo"];?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php echo $rs->fields["cod_dpa_nueva"];?></a></td>
                     <?php }
...
echo $rs->fields["nombre"]." ".$rs->fields["apellidos"]."<br>E-mail: ".$rs->fields["email"]."<br>Teléfono: ".$telef_rol;?>', ABOVE, RIGHT);"onMouseOut="return nd();" class="toolbar1"href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php echo $rs->fields["usuario"];?></a></td>
                    <td class="raya"align="center"><a onMouseOver="return overlib('<?php echo "<b>Fecha a captar:</b> ".$rs->fields["fecha_cal"];print"<br><b>Fecha de cierre de semana:</b> ".$fecha_cierre_sem."<br><b>Día a captar:</b> ";$d=substr($rs->fields["fecha_captar"],8,9);print $array[$d-1];print "<br><b>Fecha de digitación:</b> ".$fecha_dig."<br><b>Fecha de modificación:</b> ".$fecha_modif;?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php print $array2[$d-1];//print $fecha_text;?></a></td>
