...
<tr> 
                                  ...
                                  <td width="232" valign="middle" bgcolor="#B3C4DD"><strong><font color="#5A697E" size="5">Portal
                                    Municipal </font></strong></td>
                            ...
                            <td width="117" >  <a  class="menubar_principal"  href="l_datos_m.php"> 
                              ...
                              <td width="117">  <a class="menubar_principal" href="../../administracion/nomencladores/general/l_canastae.php"> 
                                        <img  src="../../imagenes/admin/sections.png" alt="Lista de productos" width="48" height="48" border="0"> 
                                        <br>
                              Canasta</a> </td>
                           ...
                           <br> <div id="id_msg" class="mensaje_negro"style="display:block"><?php 
					if($_GET["mostrar"]!="")
					{
					print $_GET["mostrar"];
					}
