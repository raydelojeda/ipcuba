        ...
        <tr> 
          ...
          <br>
            <table width="625"  border="0"cellpadding="0" cellspacing="0"   >
              <tr> 
                <td ><img src="../../imagenes/esquina_l_Up.jpg" width="20" height="18" ></td>
                <td  class="cuadro_up" align="center">&nbsp;</td>
                <td  align="center"><img src="../../imagenes/esquina_R_Up.jpg" width="19" height="19"></td>
              </tr>
              <tr> 
...
<tr> 
                                  ...
                                  <td width="232" valign="middle" bgcolor="#B3C4DD"><strong><font color="#5A697E" size="5">Portal Provincial </font></strong></td>
                        ...
                        <td width="117" >  <a  class="menubar_principal"  href="l_datos_p.php"> 
                                        <img   src="../../imagenes/admin/news.png" alt="Captaciones" width="48" height="48" border="0"> 
                                    <br>
                                    Captaciones  </a> </td>
                                  <td width="117" ><a   class="menubar_principal" href="../autor/n_captaciones.php"><img   src="../../imagenes/admin/install.png" alt="Precios Faltantes" width="48" height="48" border="0"> 
                                  <br>
                                      Precios Faltantes
                                    </a> </td>
                              <td width="117" >  <a class="menubar_principal" href="../listados/min_max_relat.php"> 
                              ...
                              Canasta</a> </td>
                                ...
                                Establecimientos</a>                                    </td>
                                    <td> <a class="menubar_principal" href="../../administracion/config/send_mail.php"> 
                                        <img src="../../imagenes/admin/massemail.png" alt=" Enviar correo hacia la ONE" width="48" height="48" border="0"> 
                                        <br>
                                    Enviar correo</a> </td>
                                  </tr>
                                 
                            </table>
                            <br> <div id="id_msg" style="display:block" class="mensaje_negro"><?php 
					if($_GET["mostrar"]!="")
					{
					print $_GET["mostrar"];
					}
