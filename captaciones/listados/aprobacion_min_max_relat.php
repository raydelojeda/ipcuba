<?php 
$locat="../listados/aprobacion_min_max_relat.php";
$x="../../";
...
if($_POST['txt_ir'])
{//print "sds";
header("Location:aprobacion_min_max_relat.php?curr_page=".$_POST['txt_ir']."&order=".$order."&type=".$ordtype."&txt_filtro=".$txt_filtro."&sel_filtro=".$sel_filtro."&ver=".$ver."&sel_cod_dpa=".$sel_cod_dpa."&sel_mes=".$sel_mes."&sel_ano=".$sel_ano."&porc=".$porc);
}
if ($_GET["order"]!="") $order = $_GET["order"]; else $order=" captacion.precio/cap.precio";
if ($_GET["type"]!="") $ordtype = $_GET["type"]; else $ordtype=asc;
...
$usuario=$rs_usuario->Fields("usuario");
$telef=$rs_usuario->Fields("telef");
$email=$rs_usuario->Fields("email");
...
//print $mes_actual;
$query = "SELECT cap.id_var_estab as id_var_estab_ant,captacion.id_var_estab as id_var_estab_act, captacion.id_cap as id_cap_act, captacion.id_usuario_aprueba as id_usuario_aprueba_act, captacion.va_a_calculo as va_a_calculo_act, cap.fecha as f_ant,captacion.fecha as f_act, cap.precio as p_ant,captacion.precio as p_act,captacion.precio/cap.precio as relat, captacion.id_var_estab,
fecha_captar,variedad, ecod_var,cod_var, n_variedad.id_variedad,id_estab_sustituido,fecha_sus, unidad,tipologia, 
cod_estab,dir,n_dpa.cod_dpa_nueva,n_estab.id_estab, estab, prov_mun_nuevo, mercado, n_mercado.id_mercado, cantidad, cap.fecha_modif as f_modif_ant, captacion.fecha_modif as f_modif_act,
                    ...
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="90%" valign="middle"  class="us"><strong><font color="#5A697E" size="2">Listado
                                 ...
                                 el mes de <?php echo $fecha_text;?> que no van al c&aacute;lculo hasta su aprobaci&oacute;n.</font></strong></td>
                          <td > 
                         <div align="center"><a class="toolbar" href="../autor/n_datos.php?locat=<?php print $locat; ?>"><img src="../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                          ...
                          <td width="4%"> <div align="center"> <a class="toolbar" href="#"> 
                              <input name="borrar" type="image" onClick="elim('aprobar.php');" src="../../imagenes/admin/publish.png" alt="Aprobar" width="32" height="32" border="0">
                              <br>
                              Aprobar</a> </div></td>
                              <td width="4%"> <div align="center"> <a class="toolbar" href="#"> 
                              <input name="borrar" type="image" onClick="elim('desaprobar.php');" src="../../imagenes/admin/unpublish.png" alt="Desaprobar" width="32" height="32" border="0">
                              <br>
                              Desaprobar</a> </div></td>
                          <td > 
  ...
  <select name="sel_#" class="inputbox"  onChange="document.frm.submit();">
    ...
    &nbsp;
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="19" class="intro" ><a href="aprobacion_min_max_relat.php?order=<?php echo "mercado" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&porc=<?php echo $porc?>&sel_mes=<?php echo $sel_mes?>&sel_ano=<?php echo $sel_ano?>">M</a></td>
                    <td width="178" class="intro" ><a href="aprobacion_min_max_relat.php?order=<?php echo "variedad" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&porc=<?php echo $porc?>&sel_mes=<?php echo $sel_mes?>&sel_ano=<?php echo $sel_ano?>">Variedad</a></td>
                    <td width="252" class="intro" ><a href="aprobacion_min_max_relat.php?order=<?php echo "estab" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&porc=<?php echo $porc?>&sel_mes=<?php echo $sel_mes?>&sel_ano=<?php echo $sel_ano?>">Establecimiento</a></td>
                    <td width="57" class="intro" align="right">U/M</td>
                    <td width="58" class="intro" align="right">Anterior</td>
                    <td width="51" class="intro" align="right" >Actual</td>
                    <td width="47" class="intro" align="right"><a href="aprobacion_min_max_relat.php?order=<?php echo "captacion.precio/cap.precio";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro;?>&sel_filtro=<?php echo $sel_filtro;?>&ver=<?php echo $ver;?>&sel_cod_dpa=<?php echo $sel_cod_dpa;?>&porc=<?php echo $porc;?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Relativo</a></td>
                   <?php if($rol!="autor") {?> <td width="64" class="intro" align="right"><a href="aprobacion_min_max_relat.php?order=<?php echo "n_dpa.cod_dpa_nueva" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&porc=<?php echo $porc?>&sel_mes=<?php echo $sel_mes?>&sel_ano=<?php echo $sel_ano?>">Cod DPA</a></td>
                   <td width="17" class="intro" ><a href="aprobacion_min_max_relat.php?order=<?php echo "captacion.va_a_calculo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&porc=<?php echo $porc?>&sel_mes=<?php echo $sel_mes?>&sel_ano=<?php echo $sel_ano?>">-</a></td>
                   <td width="20" class="intro" ><?php if($rol=="admin" || $rol=="super") {?> <input name="checkbox" onClick="marcar();" type="checkbox">
                   <?php }else print "&nbsp;";?> </td>
                   <?php }?>
                  </tr>
<?php //print $rs->RecordCount();
if($rs->fields[0]!='')
{	
  $cadenacheckboxp = "";
  	if ($rs->RecordCount() > 0)
  	{
		...
		$id_usuario_aprueba_act=$rs->fields["id_usuario_aprueba_act"];//print $id_usuario_aprueba_act;
		if($id_usuario_aprueba_act!=0 && $id_usuario_aprueba_act!="")
		{
		//---------------------------------------------------
		$query_usuario = " where id_usuario='".$id_usuario_aprueba_act."'"; 
		$sql_usuario = "select rol, id_usuario, usuario.cod_dpa,prov_mun, nombre, apellidos,usuario,telef,email from usuario,n_dpa".$query_usuario;	
		//print 	$query_usuario;
		$rs_u = $db->Execute($sql_usuario)or $mensaje=$db->ErrorMsg() ;
		$nombre=$rs_u->Fields("nombre");
		$apellidos=$rs_u->Fields("apellidos");
		$usuario=$rs_u->Fields("usuario");
		$telef=$rs_u->Fields("telef");
		$email=$rs_u->Fields("email");
		$rol=$rs_u->Fields("rol");
		$id_usuario_aprueba=$rs_u->Fields("id_usuario");
		//print $cod_dpa;
		//---------------------------------------------------	
		}
		else
		...
		$rol="";
		  ...
		  $obs=$rs->fields["obs"];
		  $va_a_calculo_act=$rs->fields["va_a_calculo_act"];
		  $f_modif_ant=$rs->fields["f_modif_ant"];
		  $f_modif_act=$rs->fields["f_modif_act"];
		  ...
		  $id_var_estab_ant=$rs->fields["id_var_estab_ant"];
				  
		  $sql2 = "select cont_imp,id_cap,va_a_calculo, precio, n_inc.id_inc, inc, obs, nombre, apellidos, rol, telef, email
		  ...
		  and captacion.id_var_estab='$id_var_estab_ant' 
		  ...
		  $id_var_estab_act=$rs->fields["id_var_estab_act"];
		  
		  $sql3 = "select cont_imp, id_cap,va_a_calculo, precio, n_inc.id_inc, inc, obs, nombre, apellidos, rol, telef, email
		  from captacion, usuario, n_inc, n_obs
		  where usuario.id_usuario=captacion.id_usuario 
		  and captacion.id_obs=n_obs.id_obs 
		  and captacion.id_inc=n_inc.id_inc 
		  and captacion.id_var_estab='$id_var_estab_act' 
		  and fecha>='$fecha_cal_inicio_sem1_actual' and fecha<'$fecha_cal_inicio_sem1_next'";
		 // print $sql3;
...
?>
                  <tr  height="20" <?php $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";?>> 
                    ...
                    <td align="right" class="raya"><?php print $rs->fields["cantidad"]." ".$rs->fields["unidad"];?></td>
                    <td align="right" class="raya"><a onMouseOver="return overlib('<?php $rol2=$rs2->fields["rol"];$telef_rol2="";
					if($rol2=="edito") 
...
echo "<b>Captado por: </b>". $rs2->fields["nombre"]." ".$rs2->fields["apellidos"]."<br>E-mail: ".$rs2->fields["email"]."<br>Teléfono: ".$telef_rol2;print "<br>";if($id_inc2!=1)echo "<b>Incidencia: </b>".$inc2;else print "<b>Observación: </b>".$obs2;if($cont_imp2)print "<br><b>Precio imputado</b>";print "<br>";if($va_a_calculo2==1){print "<img src=../../imagenes/extrasmall/button_ok.gif width=16 height=16>";print "  Entra dentro del cálculo.";} else {print "<img src=../../imagenes/extrasmall/button_cancel.gif width=16 height=16>";print "  No entra dentro del cálculo.";}print "<br><b>Fecha de digitación: </b>".$f_ant."<br><b>Fecha de modificación: </b>".$f_modif_ant;
echo "<br><br><b> UM: </b>".$rs->fields["cant_ant"]." ".$rs->fields["uni_ant"];
					  if($rs->fields["carac1"]) {echo "<br><b> ".$rs->fields["carac1"].": </b>".$rs->fields["val_ant1"];}
					  if($rs->fields["carac2"]) {echo "<br><b> ".$rs->fields["carac2"].": </b>".$rs->fields["val_ant2"];}
					  if($rs->fields["carac3"]) {echo "<br><b> ".$rs->fields["carac3"].": </b>".$rs->fields["val_ant3"];}
					  if($rs->fields["carac4"]) {echo "<br><b> ".$rs->fields["carac4"].": </b>".$rs->fields["val_ant4"];}
					  if($rs->fields["carac5"]) {echo "<br><b> ".$rs->fields["carac5"].": </b>".$rs->fields["val_ant5"];}
					  if($rs->fields["carac6"]) {echo "<br><b> ".$rs->fields["carac6"].": </b>".$rs->fields["val_ant6"];}?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" href="../autor/m_datos.php?var_aux_mod=<?php echo $rs2->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php echo number_format($p_ant, 2, ',', '');?></a></td>
                    
                    
                    <td align="right"  class="raya"><a onMouseOver="return overlib('<?php $rol3=$rs3->fields["rol"];$telef_rol3="";
					if($rol3=="edito") 
...
echo "<br><br><b> UM: </b>".$rs->fields["cant"]." ".$rs->fields["cap_uni"];
					  ...
					  if($rs->fields["carac6"]) {echo "<br><b> ".$rs->fields["carac6"].": </b>".$rs->fields["val6"];}?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" href="../autor/m_datos.php?var_aux_mod=<?php echo $rs3->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php echo number_format($p_act, 2, ',', '');?></a></td>
                    <td align="right"  class="raya"><a onMouseOver="return overlib('<?php $d=substr($rs->fields["fecha_captar"],8,9); echo "<b>Precio mes anterior:</b> ".$p_ant."  <br><b>Precio mes actual:</b> ".$p_act."<br><b>Variación porcentual:</b> ".$variacion."%";echo "<br><br><b>Fecha de captación:</b> ".$array2[$d-1]."<br><b>Fecha digitación anterior:</b> ".$f_ant."  <br><b>Fecha digitación actual:</b> ".$f_act;echo "<br><b> UM: </b>".$rs->fields["cantidad"]." ".$rs->fields["unidad"];?>', ABOVE, RIGHT);" onMouseOut="return nd();" <?php if($min >= $pre || $pre >= $max){ print "class=\"raya_roja\"";}?>class="toolbar1" ><?php echo $relat;?></a></td>
                     
					 <?php //if($rol!="autor") {print $rol;?>
                     <td class="raya"align="right"><a onMouseOver="return overlib('<?php echo "DPA: ".$rs->fields["prov_mun_nuevo"];?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" ><?php echo $rs->fields["cod_dpa_nueva"];?></a></td>
                     <td class="raya"align="center">
					 <?php 
					 
					 
					if($rol=="edito") 
					{$telef_rol=$telef."<br>Rol: Editor-ONE"; print "<img src=../imagenes/menu/edit.png border=0 >";}
					elseif($rol=="aut_p")
					{$telef_rol=$telef."<br>Rol: Autor Provincial";}
					elseif($rol=="autor")
					{$telef_rol=$telef."<br>Rol: Autor Municipal";} elseif($rol=="admin")
					{$telef_rol=$telef."<br>Rol: Administrador";}
					 
					 
					 if($va_a_calculo_act=='1' && $nombre!=""){?>
                      <a onMouseOver="return overlib('<?php echo "Aprobada la captación para el cálculo del mes ".$fecha_text." por:<br>";echo $nombre." ".$apellidos."<br>E-mail: ".$email."<br>Teléfono: ".$telef_rol;?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1"><img border="0" src="../../imagenes/tick.png"></a>
                      <?php }elseif($va_a_calculo_act=='2' && $nombre!="") {?>
                                            <a onMouseOver="return overlib('<?php echo "No aprobada la captación para el cálculo del mes ".$fecha_text." por:<br>";echo $nombre." ".$apellidos."<br>E-mail: ".$email."<br>Teléfono: ".$telef_rol;?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1"><img border="0" src="../../imagenes/publish_x.png"></a></p>
                    <?php }?></td>
                     <td class="raya"align="center"><input name="checkbox_<?php echo $rs->fields["id_cap_act"];?>" type="checkbox"  value="checkbox"></td>
                     <?php //}?>
                  </tr>
...
<?php 
			  if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["id_cap_act"];
		       	 }
				 elseif($rs->fields["id_cap_act"]!='')
				 {
		            $cadenacheckboxp .= ",".$rs->fields["id_cap_act"];
		         }
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="id_usuario_aprueba" value="<?php echo $id_usuario_aprueba;?>">
                  <input type="hidden" name="location" value="<?php echo "../captaciones/autor/l_datos_m.php";?>">
                  <input type="hidden" name="location2" value="<?php echo "aprobacion_min_max_relat.php?order=".$order."&type=".$ordtype."&txt_filtro=".$txt_filtro."&sel_filtro=".$sel_filtro."&ver=".$ver."&sel_cod_dpa=".$sel_cod_dpa."&sel_mes=".$sel_mes."&sel_ano=".$sel_ano."&porc=".$porc;?>">
                </p>
