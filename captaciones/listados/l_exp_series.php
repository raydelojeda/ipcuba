...
<tr> 
                    <td height="56" align="right" class="menudottedline"><table width="99%" border="0" class="menubar"  id="toolbar">
                      <tr >
                        ...
                        <td width="85%" valign="middle"  class="us"><font color="#5A697E">Fecha para exportar a Excel series de precios.</font></td>
                        <td width="8%"><div align="center"> <a class="toolbar" href="exp_series.php?fecha=<?php print $_POST['sel_fecha'];?>&dia=<?php print $_POST['rb_dia'];?>"  ><img name="ver" src="../../imagenes/large/vcalendar.gif" alt="Ver formularios" width="32" height="32" border="0">
                          Modelo</a> </div></td>
                      </tr>
                    </table></td>
                  </tr>
                ...
                <br>
                <table  class="tabla" width="67%" align="center">
                  <tr>
                  ...
                  <tr align="center">
                    <td width="38%" align="right">Ver despu&eacute;s de:</td>
                    <td width="62%" align="left"><div align="left">
                      <select name="sel_fecha" title="Fecha de captaci&oacute;n" id="sel_fecha" onChange="document.frm.submit();" >
                        <option value="0">---------------</option>
                        <?php 
						
						$id=$_POST['sel_fecha'];
						
						$query_sel = "select distinct fecha from captacion order by fecha desc";
						
						$rs_selected=$db->Execute($query_sel) or $mensaje=$db->ErrorMsg() ;
						$cant_rs=$rs_selected->RecordCount();
							for ($i = 0; $i < $cant_rs;$i++)
							{
								$rs_fields0=$rs_selected->Fields("fecha");
								
								$rs_fields_id=$rs_selected->Fields("fecha");										 
