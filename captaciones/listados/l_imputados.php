...
captacion.id_inc=n_inc.id_inc and cont_imp>='1' and cont_imp<='9' and
                         ...
                         <div align="center"><a class="toolbar" href="n_datos.php?locat=<?php print $locat; ?>"><img src="../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                          ...
                          <td > 
                             <div align="center"> <a class="toolbar" href="#"> 
                              <input name="borrar" type="image" onClick="elim('../../php/update.php');" src="../../imagenes/large/package_editors.gif" alt="Borrar" width="32" height="32" border="0">
                              <br>
                              Modificar</a> </div></td>
						<?php }?>
                          <td > 
...
<tr> 
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="48" class="intro" ><a href="l_datos_m.php?order=<?php echo "mercado";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Inc/Obs</a></td>
                    <td width="182" class="intro" ><a href="l_datos_m.php?order=<?php echo  "variedad";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Variedad</a></td>
                    ...
                    <td width="62" class="intro" ><a href="l_datos_m.php?order=<?php echo "fecha_captar";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Fecha
                        </a></td>
  ...
  ?>
                  <tr  height="50" <?php $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";?>> 
                    ...
                    <td  class="raya" align="center"><?php if($rs->fields["fecha_desuso"]){?>
                      <a onMouseOver="return overlib('<?php echo "Variedad dada de baja en el establecimiento el día ".$rs->fields["fecha_desuso"].".";?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1"><p><img border="0" src="../../imagenes/extrasmall/deletecell.gif"></p></a>
                      
                    <?php }?></td>
                    <td  class="raya" align="center"> <p>
                      <?php if($fecha_dig<$fecha_cierre_sem){?>
                      <a onMouseOver="return overlib('<?php echo "Precio digitado en fecha.<br><b>Fecha de digitación:</b> ".$fecha_dig;print"<br><b>Fecha de cierre de semana:</b> ".$fecha_cierre_sem;?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" ><img border="0" src="../../imagenes/tick.png"></a>
                      <?php }else {?>
                    </p>
                      <p>                        <a onMouseOver="return overlib('<?php echo "Precio digitado fuera de fecha.<br><b>Fecha de digitación:</b> ".$fecha_dig;print"<br><b>Fecha de cierre de semana:</b> ".$fecha_cierre_sem;?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1"><img border="0" src="../../imagenes/publish_x.png"></a></p>
                    <?php }?></td>
                    <td  class="raya" align="center"><a onMouseOver="return overlib('<?php if($id_inc!=1)echo $inc;else print $obs;print "<br>";echo $rs->fields["mercado"];?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" ><?php if($id_inc!=1)echo substr($inc,0,2);else print substr($obs,0,2);?></a></td>
                    ...
                    <td align="right"  class="raya"><div align="right"><a onMouseOver="return overlib('<?php echo "<b> UM: </b>".$rs->fields["cant"]." ".$rs->fields["cap_uni"];if($cont_imp)print "<br><b>Precio imputado</b>";?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" ><?php echo number_format($rs->fields["precio"], 2, ',', ' ');?></a></div></td>
...
echo $rs->fields["nombre"]." ".$rs->fields["apellidos"]."<br>E-mail: ".$rs->fields["email"]."<br>Teléfono: ".$telef_rol;?>', ABOVE, RIGHT);"onMouseOut="return nd();" class="toolbar1"><?php echo $rs->fields["usuario"];?></a></td>
                    <td class="raya"align="center"><a onMouseOver="return overlib('<?php echo "<b>Fecha a captar:</b> ".$rs->fields["fecha_cal"]."<br><b>Fecha de digitación:</b> ".$fecha_dig;print"<br><b>Fecha de cierre de semana:</b> ".$fecha_cierre_sem."<br><b>Día a captar:</b> ";$d=substr($rs->fields["fecha_captar"],8,9);print $array[$d-1];?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" ><?php print $array2[$d-1];//print $fecha_text;?></a></td>
                    <td class="raya"align="center"><input name="checkbox_<?php echo $rs->fields["id_cap"];?>" type="checkbox"  value="checkbox"></td>
                  </tr>
                  <?php 
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="location2" value="<?php echo "../captaciones/listados/l_imputados.php";?>">
                </p>
              </div>
              </form>
