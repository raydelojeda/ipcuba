...
//--------------------------------PARA OBETENER LA FECHA DEL INICIO DE SEMANA 1 DEL MES ACTUAL--------------------------------
//print $fecha_cal_inicio_sem1_pasada."<br>".$fecha_cal_inicio_sem1_actual;
...
captacion.id_inc=n_inc.id_inc and n_inc.id_inc!='1' and
...
AND n_tipologia.id_tipologia=n_estab.id_tipologia and n_obs.id_obs='1'
and  captacion.fecha>='".$fecha_base."' and captacion.fecha>='".$fecha_cal_inicio_sem1_actual."' and captacion.fecha<'".$fecha_cal_inicio_sem1_next."' and central='0'";//and fecha_creacion<='2011-01-05' and (fecha_desuso>'2011-01-05' or n_var_estab.desuso='0')
                    ...
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="90%" valign="middle"  class="us"><strong><font color="#5A697E" size="2">Listado
                                 ...
                                 el mes de <?php echo $fecha_text;?> en establecimientos con incidencias.</font></strong></td>
                          <td > 
...
<div align="center"> <a  onClick="modif('m_datos.php');" class="toolbar" href="#"> 
                ...
                <br>
                <table width="99%" height="129"  align="center" cellpadding="0" cellspacing="0"  class="tabla" id="toolbar1">
<tr align="center" valign="middle"> 
                    <td height="48" colspan="17"  > 
                        <table width="723" height="58" border="0" cellpadding="0" cellspacing="0" class="filtro" >
<tr> 
...
<select  onChange="document.frm.submit();"  name="sel_filtro">
                        ...
                        <td width="319"  align="right"><a href="#">
                              <?php
...
<tr>
  <td width="44" height="20"><div align="right">Mes:</div></td>
  <td width="172"><select name="sel_mes" id="sel_mes" onChange="javascript:document.frm.submit();">
...
<tr>
  ...
  <td  align="right">&nbsp;</td>
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="54" class="intro" ><a href="inc.php?order=<?php echo "n_inc.id_inc" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Inc</a></td>
                    <td width="249" class="intro" ><a href="inc.php?order=<?php echo "variedad" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Variedad</a></td>
                    <td width="202" class="intro" ><a href="inc.php?order=<?php echo "estab" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Establecimiento</a></td>
                    <td width="45" class="intro" ><a href="inc.php?order=<?php echo "precio" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Precio</a></td>
                    <td width="72" class="intro" ><a href="inc.php?order=<?php echo "usuario" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Usuario</a></td>
                    <td width="61" class="intro" ><a href="inc.php?order=<?php echo "fecha_captar" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Fecha
                        </a></td>
