...
if($_POST['txt_ir'])
{//print "sds";
header("Location:l_cap_serie_n.php?curr_page=".$_POST['txt_ir']."&order=".$order."&type=".$ordtype."&txt_filtro=".$txt_filtro."&sel_filtro=".$sel_filtro."&ver=".$ver."&sel_cod_dpa=".$sel_cod_dpa."&sel_mes=".$sel_mes."&sel_ano=".$sel_ano."&porc=".$porc);
}
...
and n_var_estab.id_estab=n_estab.id_estab and central='1'
                    ...
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="90%" valign="middle"  class="us"><strong><font color="#5A697E" size="2">Listado
                                 de captaciones  centralizadas nacionalmente
...
<tr> 
                  ...
                  <tr align="center" valign="center"  >
                    ...
                    <td width="64" rowspan="2" class="intro" ><a href="l_cap_serie_n.php?order=<?php echo "cod_dpa";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Cod DPA</a></td>
                    <td width="18" rowspan="2" class="intro" ><a href="l_cap_serie_n.php?order=<?php echo "mercado";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">-</a></td>
                    <td width="251" rowspan="2" class="intro" ><a href="l_cap_serie_n.php?order=<?php echo "estab";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Establecimiento</a></td>
                    <td width="212" rowspan="2" class="intro" ><a href="l_cap_serie_n.php?order=<?php echo  "variedad";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_mes=<?php echo $sel_mes;?>&sel_ano=<?php echo $sel_ano;?>">Variedad</a></td>
...
$cont_imp=$rs->fields["cont_imp"];
  ...
  ?>
                  <tr  height="50" <?php $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";?>> 
                    ...
                    <td class="raya"align="right"><div align="right"><a onMouseOver="return overlib('<?php $rol4=$rs4->fields["rol"];$telef_rol4="";
					if($rol4=="edito") 
...
echo "<b>Captado por: </b>". $rs3->fields["nombre"]." ".$rs3->fields["apellidos"]."<br>E-mail: ".$rs3->fields["email"]."<br>Teléfono: ".$telef_rol3;print "<br>";if($id_inc3!=1)echo "<b>Incidencia: </b>".$inc3;else print "<b>Observación: </b>".$obs3;if($cont_imp3)print "<br><b>Precio imputado</b>";?>', ABOVE, RIGHT);" onMouseOut="return nd();" <?php if($p3>$p4 && $p3!=0){?>class="toolbar_rojo" <?php }if($p3<$p4 && $p3!=0){?>class="toolbar_verde" <?php }else{?>class="toolbar1"<?php }?> href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php if($p3=='')
		  print "-";
...
echo "<b>Captado por: </b>". $rs2->fields["nombre"]." ".$rs2->fields["apellidos"]."<br>E-mail: ".$rs2->fields["email"]."<br>Teléfono: ".$telef_rol2;print "<br>";if($id_inc2!=1)echo "<b>Incidencia: </b>".$inc2;else print "<b>Observación: </b>".$obs2;if($cont_imp2)print "<br><b>Precio imputado</b>";?>', ABOVE, RIGHT);" onMouseOut="return nd();" <?php if($p2>$p3 && $p2!=0){?>class="toolbar_rojo" <?php }if($p2<$p3 && $p2!=0){?>class="toolbar_verde" <?php }else{?>class="toolbar1"<?php }?> href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php if($p2=='')
		  print "-";
...
echo "<b>Captado por: </b>". $rs->fields["nombre"]." ".$rs->fields["apellidos"]."<br>E-mail: ".$rs->fields["email"]."<br>Teléfono: ".$telef_rol;print "<br>";if($id_inc!=1)echo "<b>Incidencia: </b>".$inc;else print "<b>Observación: </b>".$obs;if($cont_imp)print "<br><b>Precio imputado</b>";?>', ABOVE, RIGHT);" onMouseOut="return nd();" <?php if($p1>$p2 && $p1!=0){?>class="toolbar_rojo" <?php }if($p1<$p2 && $p1!=0){?>class="toolbar_verde" <?php }else{?>class="toolbar1"<?php }?> href="m_datos.php?var_aux_mod=<?php echo $rs->fields["id_cap"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"><?php if($p=='')
		  print "-";
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="location" value="<?php echo "../captaciones/listados/l_cap_serie_n.php";?>">
                </p>
              </div>
              </form>
