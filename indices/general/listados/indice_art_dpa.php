...
if (isset($_GET["order"])) $order = $_GET["order"]; else $order="i_art_dpa.indice";
...
$query = "select e_articulo.ide_articulo, ecod_articulo, earticulo, cod_dpa_nueva, prov_mun_nuevo, i_art_dpa.indice
from e_articulo,i_art_dpa, n_dpa

where i_art_dpa.fecha='".$fecha_cal_inicio_sem1_next."' and
i_art_dpa.ide_articulo=e_articulo.ide_articulo and n_dpa.cod_dpa=i_art_dpa.cod_dpa ";
                    ...
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="90%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Listado
                                 de variaciones de micro&iacute;ndices de precios por art&iacute;culo
...
<?php }?>
                  ...
                  <tr align="center" valign="center"  > 
                    <td class="intro" width="28" height="20">No</td>
                    <td width="140" class="intro" ><a href="indice_art_dpa.php?order=<?php echo  "ecod_articulo".", ".$order ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_ano=<?php echo $sel_ano?>&sel_mes=<?php echo $sel_mes?>">Código Art&iacute;culo</a></td>
                    <td width="327" class="intro" ><a href="indice_art_dpa.php?order=<?php echo  "earticulo".", ".$order ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_ano=<?php echo $sel_ano?>&sel_mes=<?php echo $sel_mes?>">Artículo</a></td>
                    <td width="134" class="intro" ><div align="right"><a href="indice_art_dpa.php?order=<?php echo "indice";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_ano=<?php echo $sel_ano?>&sel_mes=<?php echo $sel_mes?>">Variación mensual (%)</a></div></td>
                     <td width="112" class="intro" ><?php if($rol!="autor") {?><a href="indice_art_dpa.php?order=<?php echo "n_dpa.cod_dpa".", ".$order ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_ano=<?php echo $sel_ano?>&sel_mes=<?php echo $sel_mes?>">Cod DPA</a><?php }else print "&nbsp;";?></td>
  ...
  ?>
                  <tr  height="50" <?php $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";?>> 
                    ...
                    <td align="center"  class="raya"><div align="right"><?php echo $indice;?></div></td>
                     ...
                     <td class="raya"align="center"><?php if($rol!="autor") {?><?php echo $rs->fields["cod_dpa_nueva"];?><?php }else print "&nbsp;";?></td>
