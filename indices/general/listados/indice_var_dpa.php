...
if (isset($_GET["order"])) $order = $_GET["order"]; else $order="i_var_dpa.indice";
...
$query = "select n_variedad.id_variedad, ecod_var, variedad, cod_dpa_nueva, prov_mun_nuevo, i_var_dpa.indice
from n_variedad,i_var_dpa, n_dpa
where 
 i_var_dpa.fecha='".$fecha_cal_inicio_sem1_next."' and
i_var_dpa.id_variedad=n_variedad.id_variedad and n_dpa.cod_dpa=i_var_dpa.cod_dpa ";
...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="90%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Listado
                                 de variaciones de micro&iacute;ndices de precios por variedad
...
<?php }?>
                  ...
                  <tr align="center" valign="center"  > 
                    <td class="intro" width="30" height="20">No</td>
                    <td width="131" class="intro" ><a href="indice_var_dpa.php?order=<?php echo  "ecod_var".", ".$order ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_ano=<?php echo $sel_ano?>&sel_mes=<?php echo $sel_mes?>">Código Variedad</a></td>
                    <td width="311" class="intro" ><a href="indice_var_dpa.php?order=<?php echo  "variedad".", ".$order ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_ano=<?php echo $sel_ano?>&sel_mes=<?php echo $sel_mes?>">Variedad</a></td>
                    <td width="159" class="intro" ><div align="right"><a href="indice_var_dpa.php?order=<?php echo "i_var_dpa.indice";?>&type=<?php echo $ordtypestr;?>&txt_filtro=<?php echo $txt_filtro;?>&sel_filtro=<?php echo $sel_filtro;?>&ver=<?php echo $ver;?>&sel_cod_dpa=<?php echo $sel_cod_dpa;?>&sel_ano=<?php echo $sel_ano;?>&sel_mes=<?php echo $sel_mes;?>">Variación mensual (%)</a></div></td>
                     <td width="110" class="intro" ><?php if($rol!="autor") {?><a href="indice_var_dpa.php?order=<?php echo "n_dpa.cod_dpa_nueva";?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>&sel_cod_dpa=<?php echo $sel_cod_dpa?>&sel_ano=<?php echo $sel_ano?>&sel_mes=<?php echo $sel_mes?>">Cod DPA</a><?php }else print "&nbsp;";?></td>
