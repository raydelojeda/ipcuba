                    ...
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="69%" valign="middle"  class="us"><strong><font color="#5A697E" size="3">Listado
                                 de &iacute;ndices por art&iacute;culo y mercado
     <?php if($fecha_text!="") {?>                            
en
                ...
                <table width="99%" class="tabla" >
                  <tr align="center" valign="middle">
                    <td height="23" colspan="16"  ><table width="467" height="32" border="0" cellpadding="0" cellspacing="0" class="filtro" >
                      <tr>
                        <td width="136" height="20"><div align="right">Mes:</div></td>
                  ...
                  <tr align="center" valign="center"  >
                    <td width="6%" height="44" class="intro">
                      N</td>
                    <td width="53%"   class="intro">Agregados </td>
                    <td width="30%"  align="right"  class="intro">&Iacute;ndice</td>
                    <td width="11%"   class="intro">&nbsp;</td>
                  </tr>
                  <?php
if($rs->fields[0]!='')
{	
...
$sql_i_articulo = "select indice from i_articulo, g_articulo
where g_articulo.ide_articulo='$ide_articulo'
and g_articulo.idg_articulo=i_articulo.idg_articulo
and i_articulo.fecha='$fecha_cal_inicio_sem1_next'";//print "<br>".$sql_i_articulo;						
$rs_i_articulo = $db->Execute($sql_i_articulo)or die($db->ErrorMsg());

$ind_art=number_format(($rs_i_articulo->fields["indice"])*100, 3, ',', '');
