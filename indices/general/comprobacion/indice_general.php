...
//---------------------------------------------------					 
$sql_fecha = "select max(fecha) from g_variedad";		
...
from i_general
WHERE i_general.fecha='$fecha_cal_inicio_sem1_next'";//print $sql;
...
,i_articulo.indice as ind_art
,i_subclase.indice as ind_sub
,i_clase.indice as ind_cla
,i_grupo.indice as ind_gru
,i_division.indice as ind_div
from 
n_division,g_division,i_division 

,n_grupo,g_grupo,i_grupo
,n_clase,g_clase,i_clase
,e_subclase,g_subclase,i_subclase
,e_articulo,g_articulo,i_articulo


WHERE 


n_division.id_division = n_grupo.id_division and n_division.id_division = g_division.id_division and i_division.idg_division=g_division.idg_division 

AND n_grupo.id_grupo=n_clase.id_grupo AND n_grupo.id_grupo=g_grupo.id_grupo AND i_grupo.idg_grupo=g_grupo.idg_grupo 

AND n_clase.id_clase=e_subclase.id_clase AND n_clase.id_clase=g_clase.id_clase AND i_clase.idg_clase=g_clase.idg_clase 

AND e_subclase.ide_subclase=e_articulo.ide_subclase AND e_subclase.ide_subclase=g_subclase.ide_subclase AND i_subclase.idg_subclase=g_subclase.idg_subclase 

and e_articulo.ide_articulo = g_articulo.ide_articulo and i_articulo.idg_articulo=g_articulo.idg_articulo  
...
////,n_variedad AND  (e_articulo.ide_articulo = n_variedad.ide_articulo),coi_var 
...
$sql = "select i_general.indice as ind_gen";

$sql=$sql." from i_general";

$sql=$sql." WHERE i_general.fecha='$fecha_cal_inicio_sem1_next'";
...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="69%" valign="middle"  class="us"><font color="#5A697E" size="2">&Iacute;ndices para la comprobaci&oacute;n, Base Dic. 2010</font></td>
                ...
                <table width="99%" class="tabla" >
                  <tr align="center" valign="middle">
                    <td height="55" colspan="16"  ><table width="635" height="50" border="0" cellpadding="0" cellspacing="0" class="filtro" >
                      <tr>
                      <td width="199" height="50"><div align="right">Mes:</div></td>
                        <td width="187"><select name="sel_mes" id="sel_mes" onChange="javascript:document.frm.submit();">
                        ...
                        <td width="79"  align="center"><div align="right">A&ntilde;o:</div></td>
                        <td width="170"  align="center"><div align="left">
...
//print $rs->fields["ini_div"]."   ".$rs->fields["ini_div_ant"];
...
$nivel=$nivel+1;
   ?>
                  <?php if($coi_division_0!=$rs->fields["cod_division"]) {?>
                  ...
                  <tr  id="tt<?php print $nivel;?>"<?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    ...
                    <td  class="raya" height="29" >  
                      <?php $coi_division_0=$rs->fields["cod_division"]; echo $rs->fields["cod_division"].". ";echo $rs->fields["division"];?>                      </td>
                    <td  class="raya" ><div align="right"><?php print $ind_div; ?></div></td>
                    <td  class="raya" >&nbsp;</td>
                  </tr>
                  
                  <?php } if($coi_grupo_0!=$rs->fields["cod_grupo"]) {?>
                  <a  name="2">                  
                  <tr id="nivel_2<?php print $nivel;?>"<?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    ...
                    <td  class="raya" height="29" >&nbsp;&nbsp;  
                      <?php $coi_grupo_0=$rs->fields["cod_grupo"]; echo $rs->fields["cod_grupo"].". ";echo $rs->fields["grupo"];?>                      </td>
                    <td  class="raya" ><div align="right"><?php print $ind_gru; ?></div></td>
                    <td  class="raya" >&nbsp;</td>
                  </tr>
                  <a  name="2">
                  <?php } if($coi_clase_0!=$rs->fields["cod_clase"]) {?>
                  <a name="3">                  
                  <tr id="nivel_3<?php print $nivel;?>"<?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    ...
                    <td  class="raya" height="29" >&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <?php $coi_clase_0=$rs->fields["cod_clase"]; echo $rs->fields["cod_clase"].". ";echo $rs->fields["clase"];?>                      </td>
                    <td  class="raya" ><div align="right"><?php print $ind_cla; ?></div></td>
                    <td  class="raya" >&nbsp;</td>
                  </tr>
                  <a name="3">
                  <?php } if($coi_subclase_0!=$rs->fields["cod_subclase"]) {?>
                  <a name="4">                  
                  <tr id="nivel_4<?php print $nivel;?>"<?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                   ...
                   <?php if($coi_subclase_01!=generico){?> <td  class="raya" height="29" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       
                      <?php $coi_subclase_0=$rs->fields["cod_subclase"]; echo $rs->fields["cod_subclase"].". ";echo $rs->fields["subclase"];?>
                      </td>
                  ...
                  <a name="4">
                  <?php } if($ecoi_articulo_0!=$rs->fields["ecod_articulo"]) {?>
                  <a name="5">                  
                  <tr id="nivel_5<?php print $nivel;?>"<?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    ...
                    <td  class="raya" height="29" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <?php $ecoi_articulo_0=$rs->fields["ecod_articulo"];echo $rs->fields["ecod_articulo"].". ";echo $rs->fields["earticulo"];?>                    </td>
