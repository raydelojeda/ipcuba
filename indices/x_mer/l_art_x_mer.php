...
<tr> 
                    <td height="56" align="right" class="menudottedline"><table width="99%" border="0" class="menubar"  id="toolbar">
                      <tr >
                        <td width="7%" height="50" valign="middle"  class="us"><img src="../../imagenes/large/folder_documents.gif" alt="" width="48" height="48" border="0"><strong><font color="#000000" size="1"> </font></strong></td>
                        <td width="85%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">C&aacute;lculo de &iacute;ndices a nivel de art&iacute;culo  por mercado.</font></strong></td>
                        <td width="8%"><div align="center"> <a class="toolbar" href="cal_indice_x_mer.php?&sel_mes=<?php print $_POST['sel_mes'];?>&sel_ano=<?php print $_POST['sel_ano'];?>&sel_mercado=<?php print $_POST['sel_mercado'];?>"  ><img name="ver" src="../../imagenes/large/run.gif" alt="Calcular" width="48" height="48" border="0">
                          Calcular</a> </div></td>
                      </tr>
                    </table></td>
                  </tr>
                ...
                <table  class="tabla" width="38%" align="center">
	     		...
	     		<?php }?>
                  ...
                  <tr>
                    ...
                    <td><select name="sel_mercado" title="Mercado" id="sel_mercado" onChange="javascript:document.frm.submit();">
                      <option value="0">-----------------------</option>
                      <?php 
