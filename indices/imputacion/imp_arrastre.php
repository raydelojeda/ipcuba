...
{		
	...
	for($dpa=1;$dpa<=$cant_dpa;$dpa++)
	{
		...
		{ 
			...
			$sql_cap = "UPDATE captacion SET va_a_calculo='1',id_inc='1',id_obs='6', precio ='".$p_ant."', cont_imp='9' 
			WHERE id_cap = '".$id_cap_act."'and captacion.fecha>='$fecha_cal_inicio_sem1_actual' 
			and captacion.fecha<'$fecha_cal_inicio_sem1_next' and captacion.precio=0";//print $sql_cap."<br>";
