...
<tr> 
                    <td height="56" align="right" class="menudottedline"><table width="99%" border="0" class="menubar"  id="toolbar">
                      <tr >
                        ...
                        <td width="85%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Imputaci&oacute;n de precios de art&iacute;culos estacionales para un mes.</font></strong></td>
                        <td width="8%"><div align="center"> <a class="toolbar" href="imp_1.php?&sel_mes=<?php print $_POST['sel_mes'];?>&sel_ano=<?php print $_POST['sel_ano'];?>"  ><img name="ver" src="../../imagenes/admin/restore_f2.png" alt="Imputar" width="32" height="32" border="0">
                          Imputar</a> </div></td>
                      </tr>
                    </table></td>
                  </tr>
