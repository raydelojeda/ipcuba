...
<tr> 
                    <td height="56" align="right" class="menudottedline"><table width="99%" border="0" class="menubar"  id="toolbar">
                      <tr >
                        <td width="7%" height="50" valign="middle"  class="us"><img src="../imagenes/large/editdelete.gif" alt="" width="48" height="48" border="0"><strong><font color="#000000" size="1"> </font></strong></td>
                        <td width="85%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Eliminar el &uacute;ltimo mes calculado.</font></strong></td>
                        <td width="8%"><div align="center"> <a class="toolbar" href="elim_datos.php"  ><img name="ver" src="../imagenes/large/button_cancel.gif" alt="Validar" width="48" height="48" border="0">
                          Eliminar</a> </div></td>
                      </tr>
                    </table></td>
                  </tr>
                ...
                <br>
                <table  class="tabla" width="49%" align="center">
	     		...
	     		<?php }?>
                  <tr>
                    <td width="100%" height="47" colspan="2" align="center">Est&aacute; seguro de eliminar los datos del &uacute;ltimo mes calculado.</td>
                  </tr>
                </table>
                <p>&nbsp;</p>
                <p>
