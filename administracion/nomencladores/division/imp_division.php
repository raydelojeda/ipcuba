...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><div align="center"><strong>División</strong></div></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
                
                <table width="97%" border="0" cellpadding="0" cellspacing="0" class="imprimir">
  	...
  	?>
                  ...
                  <tr align="center" valign="center"  > 
                    <td class="imp_celda" width="13%" height="21">No</td>
                    <td class="imp_celda"width="32%" >Código División</td>
                    <td width="55%" class="imp_celda"> 
                      <div align="left">División</div></td>
                  </tr>
                  <?php
 	if ($rs->RecordCount() > 0)
  	{
