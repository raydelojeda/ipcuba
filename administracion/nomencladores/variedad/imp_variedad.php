...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><strong>Variedad</strong></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
  	...
  	?><div align="right">
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td class="imp_celda"width="46%" >Código Variedad</td>
                    <td width="43%" class="imp_celda"> 
  ...
  ?>
                  <tr> 
                    ...
                    <td class="imp_celda" align="center"><?php echo $rs->fields["cod_variedad"];?></td>
                    <td class="imp_celda"> <div align="left"><?php echo $rs->fields["variedad"];?></div></td>
                  </tr>
                  <?php 
