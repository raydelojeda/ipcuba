...
<div align="right">
<div align="right">Código de la clase:</div></td>
                  <td width="71%"> 
                    <div align="left"> 
                      <input name="txt_cod_clase" type="text"  class="combo" id="txt_cod_clase" title="Código de la Clase" value="<?php echo $rs->fields["cod_clase"]; ?>" size="50">
                    </div></td>
                </tr>
                <tr> 
