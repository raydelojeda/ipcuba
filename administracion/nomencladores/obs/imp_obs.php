...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><strong>Observaciones</strong></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
  	...
  	?> 
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td class="imp_celda"width="28%" >Código Observasión</td>
                    <td width="61%" class="imp_celda"> 
                      <div align="left">Observasiones</div></td>
                  </tr>
                  <?php
 	if ($rs->RecordCount() > 0)
  	{
  ...
  ?>
                  <tr> 
                    ...
                    <td class="imp_celda" align="center"><?php echo $rs->fields["id_obs"];?></td>
                    <td class="imp_celda"> <div align="left"><?php echo $rs->fields["obs"];?></div></td>
                  </tr>
                  <?php 
