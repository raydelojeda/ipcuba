...
if(isset($_POST['txt_obs']))
{
	...
	$txt_obs = $db->qstr($_POST['txt_obs'], $magic_quotes);
 ...
 /*				$tabla="n_division";
			 ...
			 */
				 $sql="INSERT INTO n_obs (obs) VALUES ($txt_obs)";
//print $sql;
				 $rs=$db->Execute($sql) or $die=$db->ErrorMsg() ;//print "Ya existe la persona en la Base de Datos."
  	  
				 $mensaje="La observasión ha sido insertada satisfactoriamente.";
			//	}
			}			
			 else
			 $mensaje="Ya existe una observasión en la BD.";
		}
		else
		$mensaje="Ya existe un código de observasión en la BD.";
	 }	 
	else
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
            <form  method="post" id="frm"  action="" name="frm" onSubmit="MM_validateForm('','','Escoger','','','R','txt_obs','','RLetras');return document.MM_returnValue">
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control 
                          de la observación: <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="7%"> <div align="center"> <a class="toolbar" href="../obs/l_obs.php"> 
                            <img name="imageField2" src="../../../imagenes/cancel_f2.png" alt="Cerrar" width="32" height="32" border="0"> 
                            <br>
                            Cancelar</a> </div></td>
                        <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/n_obs.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <table width="679" align="center" class="tabla">
                <tr> 
                  <td width="150">&nbsp;</td>
                  <td width="511">&nbsp;</td>
                </tr>
                <tr align="center" > 
                  <td height="14"><div align="right">Observaciones:</div></td>
                  <td height="14"><div align="left"> 
                      <input name="txt_obs"  type="text" id="txt_obs"  title="observasiones" size="80">
                    </div></td>
                </tr>
                <tr align="center" > 
