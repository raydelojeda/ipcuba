...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="61%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Administración 
                            de la observación</font></strong></td>
                          <td width="0%"> <div align="center"><a class="toolbar" href="../obs/n_obs.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="6%"> <div align="center"> <a  onClick="modif('m_obs.php');" class="toolbar" href="#"> 
                          ...
                          <td width="6%"> <div align="center"> <a class="toolbar" href="#"> 
                              ...
                              <br>
                              Borrar</a> </div></td>
                          <td width="9%"> <div align="center"> <a  class="toolbar" href="../jhgfjyit/imp_obs.php?no=<?php $b=$pager_nav->index_rs; echo $b; ?>%20" target="_blank" > 
                              <img   src="../../../imagenes/admin/print.png" alt="Imprimir" width="32" height="32" border="0"> 
                              <br>
                              Imprimir</a> </div></td>
                          <td width="12%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/l_obs.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
                ...
                <br>
                <table width="93%"   align="center" cellpadding="0" cellspacing="0"  class="tabla" id="toolbar1">
                  <thead>
                    <tr align="center" valign="middle"> 
                      <td height="39"  colspan="7"  > <div align="right"><a href="#"> 
                          <?php
                      ...
                      <td width="61%"  align="left"  > 
                        <div align="right">Filtro: 
                          ...
                          <select  onChange="document.frm.submit();" class="combo" name="sel_filtro">
                            ...
                            <option value="<?php echo "id_obs" ?>"<?php if ($sel_filtro == "id_obs") { echo "selected"; } ?>><?php echo htmlspecialchars("id obs") ?></option>
                            <option value="<?php echo "obs" ?>"<?php if ($sel_filtro == "obs") { echo "selected"; } ?>><?php echo htmlspecialchars("obs") ?></option>
                          </select>
                        </div></td>
                    ...
                    <tr align="center" valign="center"  > 
                      <td class="intro" width="7%" height="21">No</td>
                      <td colspan="2" class="intro"> <div align="center"><a href="../jhgfjyit/l_obs.php?order=<?php echo "unidad" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Observaciones</a></div></td>
                      <td class="intro" width="8%">&nbsp; </td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
...
{	
  ...
  ?>
                    <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                      ...
                      <td class="raya" height="26"colspan="2" align="center"><a href="../obs/m_obs.php?var_aux_mod=<?php echo $rs->fields["id_obs"];?>"> 
                        <?php echo $rs->fields["obs"];?> </a> <div align="center"></div></td>
                      <td class="raya" height="26"align="right" valign="middle"> 
                        <input name="checkbox_<?php echo $rs->fields["id_obs"];?>" type="checkbox"  value="checkbox"> 
                      </td>
                    </tr>
                    <?php 
     ...
     if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["id_obs"];
		       	 }
				 else
				 {
		            $cadenacheckboxp .= ",".$rs->fields["id_obs"];
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "n_obs";?>">
                  <input type="hidden" name="campo" value="<?php echo "id_obs";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/nomencladores/obs/l_obs.php";?>">
                </p>
              </div>
              </form>
