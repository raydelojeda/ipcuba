...
include($x."php/session/session_super.php");
	...
	if (isset($_POST['txt_obs']))
	{
	   ...
	   $txt_obs=$_POST["txt_obs"];
		 ...
		 // else
		//  {
		$sql = "UPDATE n_obs  SET obs = '".$_POST["txt_obs"]."'  WHERE id_obs = '".$_POST["var_id"]."'";
		//print $sql;
		$rs = $db->Execute($sql) or $mensaje=$db->ErrorMsg() ;
		//print $rs->Fields(0);
		if($rs)	
		header("Location: l_obs.php");
		else
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
            <form name="frm"  id="frm" method="post" action="" onSubmit="MM_validateForm('','','Escoger','','','R','txt_obs','','R');return document.MM_returnValue">
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
<tr>
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control 
                          de la observaci&oacute;n: <font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="../obs/l_obs.php"> 
                            ...
                            <br>
                    Cancelar</a> </div></td>
                <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/m_obs.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
...
<div align="right">
<div align="right">Observasiones:</div></td>
                  <td width="82%"> 
                    <div align="left"> 
                      <input name="txt_obs" type="text"  class="combo" id="txt_obs" title="obs" value="<?php echo $rs->fields["obs"]; ?>" size="80">
                      <input  type="hidden" name="var_id" value="<?php echo $rs->fields["id_obs"]?>">
                  </div>                    </td>
                </tr>
                <tr> 
