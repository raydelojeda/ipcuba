...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="61%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Administración 
                            de la tipología</font></strong></td>
  ...
  &nbsp;</div></td>
                    ...
                    <tr align="center" valign="center"  > 
                      ...
                      <td colspan="3" class="intro"> <div align="center"><a  href="l_tipologia.php?order=<?php echo "tipologia" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Tipología nacional</a></div></td>
...
{	
  ...
  ?>
                    <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                      ...
                      <td class="raya" height="26"colspan="3" align="center"><a class="toolbar1" onMouseOver="return overlib('<?php echo "Tipología: ".$rs->fields["id_tipologia_nueva"]." ".$rs->fields["tipologia_nueva"];?>', ABOVE, RIGHT);" onMouseOut="return nd();" href="m_tipologia.php?var_aux_mod=<?php echo $rs->fields["id_tipologia"];?>"> 
