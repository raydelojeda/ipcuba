...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><strong>Tipología</strong></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
                
                <table width="96%" border="0" cellpadding="0" cellspacing="0" class="imprimir">
  	...
  	?> 
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td class="imp_celda"width="28%" >Código Tipología</td>
                    <td width="61%" class="imp_celda"> 
                      <div align="left">Tipología</div></td>
                  </tr>
                  <?php
 	if ($rs->RecordCount() > 0)
  	{
  ...
  ?>
                  <tr> 
                    ...
                    <td class="imp_celda" align="center"><?php echo $rs->fields["id_tipologia"];?></td>
                    <td class="imp_celda"> <div align="left"><?php echo $rs->fields["tipologia"];?></div></td>
                  </tr>
                  <?php 
