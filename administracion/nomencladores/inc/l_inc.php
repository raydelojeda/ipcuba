                    ...
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="61%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Administración
                                 de la incidencia </font></strong></td>
                          <td width="0%"> <div align="center"><a class="toolbar" href="../inc/n_inc.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="6%"> <div align="center"> <a  onClick="modif('m_inc.php');" class="toolbar" href="#"> 
                          ...
                          <td width="6%"> <div align="center"> <a class="toolbar" href="#"> 
                              ...
                              <br>
                              Borrar</a> </div></td>
                          <td width="9%"> <div align="center"> <a  class="toolbar" href="../jhgfjyit/imp_inc.php?no=<?php $b=$pager_nav->index_rs; echo $b; ?>%20" target="_blank" > 
                              <img   src="../../../imagenes/admin/print.png" alt="Imprimir" width="32" height="32" border="0"> 
                              <br>
                              Imprimir</a> </div></td>
                          <td width="12%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/l_inc.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
                ...
                <table width="93%"   align="center" cellpadding="0" cellspacing="0"  class="tabla" id="toolbar1">
                  <thead>
                      ...
                      <td width="61%"  align="left"  > 
                        <div align="right">Filtro: 
                          ...
                          <select  onChange="document.frm.submit();" class="combo" name="sel_filtro">
                            ...
                            <option value="<?php echo "id_inc" ?>"<?php if ($sel_filtro == "id_inc") { echo "selected"; } ?>><?php echo htmlspecialchars("id inc") ?></option>
                            <option value="<?php echo "inc" ?>"<?php if ($sel_filtro == "inc") { echo "selected"; } ?>><?php echo htmlspecialchars("inc") ?></option>
                          </select>
                        </div></td>
                    ...
                    <tr align="center" valign="center"  > 
                      ...
                      <td colspan="2" class="intro"> <div align="center"><a href="../jhgfjyit/l_inc.php?order=<?php echo "unidad" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Incidencias</a></div></td>
...
{	
  ...
  ?>
                    <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                      ...
                      <td class="raya" height="26"colspan="2" align="center"><a href="../inc/m_inc.php?var_aux_mod=<?php echo $rs->fields["id_inc"];?>"> 
                        <?php echo $rs->fields["inc"];?> </a> <div align="center"></div></td>
                      <td class="raya" height="26"align="right" valign="middle"> 
                        <input name="checkbox_<?php echo $rs->fields["id_inc"];?>" type="checkbox"  value="checkbox"> 
                      </td>
                    </tr>
                    <?php 
     ...
     if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["id_inc"];
		       	 }
				 else
				 {
		            $cadenacheckboxp .= ",".$rs->fields["id_inc"];
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "n_inc";?>">
                  <input type="hidden" name="campo" value="<?php echo "id_inc";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/nomencladores/inc/l_inc.php";?>">
                </p>
              </div>
              </form>
