...
if(isset($_POST['txt_inc']))
{
	...
	$txt_inc = $db->qstr($_POST['txt_inc'], $magic_quotes);
 ...
 /*				$tabla="n_division";
			 ...
			 */
				 $sql="INSERT INTO n_inc (inc) VALUES ($txt_inc)";
//print $sql;
				 $rs=$db->Execute($sql) or $die=$db->ErrorMsg() ;//print "Ya existe la persona en la Base de Datos."
  	  
				 $mensaje="La incervasión ha sido insertada satisfactoriamente.";
			//	}
			}			
			 else
			 $mensaje="Ya existe una incervasión en la BD.";
		}
		else
		$mensaje="Ya existe un código de incervasión en la BD.";
	 }	 
	else
...
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control
                              de la incidencia: <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="7%"> <div align="center"> <a class="toolbar" href="../inc/l_inc.php"> 
                            ...
                            <br>
                            Cancelar</a> </div></td>
                        <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/n_inc.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <table width="679" align="center" class="tabla">
                ...
                <tr align="center" > 
                  <td height="14"><div align="right">Incidencias:</div></td>
                  <td height="14"><div align="left"> 
                      <input name="txt_inc"  type="text" id="txt_inc"  title="Incidencia" size="80">
                    </div></td>
                </tr>
                <tr align="center" > 
