...
include($x."php/session/session_super.php");
	//print $rs->fields["id"];
	$mensaje = "";
	if (isset($_POST['txt_inc']))
	{
	 
	   $txt_inc=$_POST["txt_inc"];
		 ...
		 // else
		//  {
		$sql = "UPDATE n_inc  SET inc = '".$_POST["txt_inc"]."'  WHERE id_inc = '".$_POST["var_id"]."'";
		//print $sql;
		$rs = $db->Execute($sql) or $mensaje=$db->ErrorMsg() ;
		//print $rs->Fields(0);
		if($rs)	
		header("Location: l_inc.php");
		else
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
            <form name="frm"  id="frm" method="post" action="" onSubmit="MM_validateForm('','','Escoger','','','R','txt_inc','','R');return document.MM_returnValue">
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
<tr>
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control
                              de la incidencia: <font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="../inc/l_inc.php"> 
                            <img name="imageField2" src="../../../imagenes/admin/cancel_f2.png" alt="Cerrar" width="32" height="32" border="0"> 
                            <br>
                    Cancelar</a> </div></td>
                <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/m_inc.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <p>&nbsp;</p>     
              <table width="97%"  align="center"  class="tabla">
                <tr> 
                  <td width="18%" height="34"> 
<div align="right">
<div align="right">Incidencia:</div></td>
                  <td width="82%"> 
                    <div align="left"> 
                      <input name="txt_inc" type="text"  class="combo" id="txt_inc" title="inc" value="<?php echo $rs->fields["inc"]; ?>" size="80">
                      <input  type="hidden" name="var_id" value="<?php echo $rs->fields["id_inc"]?>">
                  </div>                    </td>
                </tr>
                <tr> 
