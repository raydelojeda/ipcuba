<?php
$x="../../../";
$tabla="n_correlacionador";
$campo="id_correlacionador";
$location="l_correlacionador.php";
include($x."php/modificar.php");
include($x."php/session/session_super.php");
	//print $rs->fields["id"];
	$mensaje = "";
	if (isset($_POST['txt_factor']))
	{
	 
	   $txt_factor=$_POST["txt_factor"];
		 
		$sql = "UPDATE n_correlacionador  SET factor = '".$_POST["txt_factor"]."'  WHERE id_correlacionador = '".$_POST["var_id"]."'";
		//print $sql;
		...
		header("Location: l_correlacionador.php");
		}			
		else
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
            <form name="frm"  id="frm" method="post" action="" onSubmit="MM_validateForm('','','Escoger','','','R','txt_unidad','','R');return document.MM_returnValue">
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
<tr>
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control 
                          del correlacionador: <font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_correlacionador.php"> 
                            ...
                            <br>
                    Cancelar</a> </div></td>
                <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/m_unidad.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <p>&nbsp;</p>     
              <table width="57%"  align="center"  class="tabla">
                
                <tr> 
                  <td width="29%" height="34"><div align="right">
                  <div align="right">Factor:</div></td>
                  <td width="71%"><div align="left"> 
                      <input name="txt_factor" type="text"  class="combo" id="txt_factor" title="Factor de conversión" value="<?php echo $rs->fields["factor"]; ?>">
                      <input  type="hidden" name="var_id" value="<?php echo $rs->fields["id_correlacionador"]?>">
                  </div>                    </td>
                </tr>
                <tr> 
