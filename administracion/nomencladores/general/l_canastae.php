...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          <td width="7%" valign="middle"  class="us"><img src="../../../imagenes/large/lists.gif" width="48" height="48" border="0"><strong><font color="#000000" size="1"> 
                            </font></strong></td>
                          <td width="69%" valign="middle"  class="us"><font color="#5A697E" size="4">Lista de bienes y servicios Base Dic. 2010</font></td>
                ...
                <table width="99%" class="tabla" >
                  <tr align="center" valign="middle"> 
                    <td height="36" colspan="16"  > <div align="right"><a href="#">&nbsp;&nbsp;
                  ...
                  <tr align="center" valign="center"  >
                    ...
                    <td  height="22" width="5%" class="intro">
  ...
  $cadenacheckboxp = "";
   ...
   ?>
                  ...
                  <tr <?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    ...
                    <td  class="raya">&nbsp;</td>
                    <td  class="raya">6</td>
                    <td  class="raya" width="77%" height="29" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
