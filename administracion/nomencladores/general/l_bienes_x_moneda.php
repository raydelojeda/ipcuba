...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="69%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Distribuci&oacute;n de muestral por monedas</font></strong></td>
                ...
                <table width="94%" class="tabla" >
                  <tr align="center" valign="middle"> 
                    <td height="37" colspan="18"  > <div align="right"><a href="#">&nbsp;&nbsp;
                  ...
                  <tr align="center" valign="center"  >
                    <td align="center" class="intro">&nbsp;</td>
                    <td  height="22" align="center" class="intro">&nbsp;</td>
                    <td   class="intro">&nbsp;</td>
                    <td colspan="3"   class="intro">&nbsp;</td>
                  </tr>
                  <tr align="center" valign="center"  >
                    <td width="3%" class="intro"><div align="center">N</div></td>
                    <td width="13%" class="intro"># </td>
                    <td   class="intro">Agregados </td>
                    <td align="right"   class="intro">CUP</td>
                    <td align="right"   class="intro">CUC</td>
                    <td align="left"   class="intro">&nbsp;</td>
                  </tr>
                  <?php
if($rs->fields[0]!='')
{	
  $cadenacheckboxp = "";
   ...
   ?>
                  ...
                  <tr <?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    <td align="center"  class="raya">1</td>
                    ...
                    <td align="left"  class="raya" ><div align="center"></div></td>
                    <td align="left"  class="raya" ><div align="center"></div></td>
                    <td align="left"  class="raya" >&nbsp;</td>
                  </tr>
				...
				$gru_r_peso_3=number_format($rs_gru_3->fields["r_peso"], 3, ',', ' ');
				  ?>
                  <tr <?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    <td align="center"  class="raya">2</td>
                    <td  class="raya">&nbsp;&nbsp;&nbsp;&nbsp;
                      <?php  $g=$g+1;echo $g; ?></td>
				...
				$cla_r_peso_3=number_format($rs_cla_3->fields["r_peso"], 3, ',', ' ');
				  ?>
                  <tr <?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    <td align="center"  class="raya">3</td>
                    <td  class="raya">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <?php  $c=$c+1;echo $c; ?></td>
				  ...
				  ?>
                  <tr <?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    <td align="center"  class="raya">4</td>
                    <td  class="raya">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <?php  $s=$s+1;echo $s; ?></td>
                  ...
                  <?php } if($ecod_articulo_0!=$rs->fields["ecod_articulo"]) {
					...
					$sql_art_1 = "select g_peso from b_articulo 
					...
					$sql_art_2 = "select g_peso from b_articulo 
					where ide_articulo='$ide_articulo' and id_mercado_nuevo='2'";//print $sql_art_2;//where fecha='$fecha_i_var_dpa'
					$rs_art_2 = $db->Execute($sql_art_2) or die($db->ErrorMsg());
					$art_g_peso_2=number_format($rs_art_2->fields["g_peso"], 3, ',', ' ');
					
					$total=$rs_art_1->fields["g_peso"]+$rs_art_2->fields["g_peso"];//print $total;die();
					$porc_cup=number_format($rs_art_1->fields["g_peso"]/$total*100, 0, ',', ' ')." %";
					$porc_cuc=number_format($rs_art_2->fields["g_peso"]/$total*100, 0, ',', ' ')." %";
				  ?>
                  <tr <?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    <td align="center"  class="raya">5</td>
                    <td  class="raya">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <?php  $v=$v+1;echo $v; ?></td>
                  ...
                  <td align="right"  class="raya" ><?php  print $porc_cup;?></td>
                    <td align="right"  class="raya" ><?php  print $porc_cuc;?></td>
                    <td align="right"  class="raya" >&nbsp;</td>
                  </tr>
                  <?php } 
				  ...
				  ?>
                  <tr <?php  $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> >
                    <td align="center"  class="raya">6</td>
                    <td  class="raya">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  $f=$f+1;echo $f; ?></td>
                    <td  class="raya" width="65%" height="29" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    ...
                    <td  class="raya" width="7%"align="left" ><div align="center"></div></td>
                    <td  class="raya" width="5%"align="left" >&nbsp;</td>
                  </tr>
                  <?php 
				//  $r->MoveNext();
			//}
