                    ...
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar" id="toolbar"  >
                        <tr  > 
                          ...
                          <div align="center"><a class="toolbar" href="n_estab.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td><?php }?>
                          <td width="1%"> <div align="center"> <a  onClick="modif('m_estab.php');" class="toolbar" href="#"> 
  ...
  if($rs->fields[0]!='')
{
  ...
  ?>
                  <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                    ...
                    <td class="raya"colspan="2"  align="center"><a onMouseOver="return overlib('<?php echo $rs->fields["mercado"];?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1" href="../estab/m_estab.php?var_aux_mod=<?php echo $rs->fields["id_estab"];?>"><?php echo substr($rs->fields["mercado"],0,1);?></a></td>
                    <td class="raya"align="center"><a class="toolbar1" href="../estab/m_estab.php?var_aux_mod=<?php echo $rs->fields["id_estab"];?>"><?php echo $rs->fields["tipologia"];?></a></td>
                    <td class="raya"align="center"><a onMouseOver="return overlib('<?php echo $rs->fields["prov_mun"];?>', ABOVE, RIGHT);" onMouseOut="return nd();"  href="../estab/m_estab.php?var_aux_mod=<?php echo $rs->fields["id_estab"];?>"><?php echo $rs->fields["cod_dpa"];?></a></td>
                    <td class="raya" align="center"><a class="toolbar1" href="../estab/m_estab.php?var_aux_mod=<?php echo $rs->fields["id_estab"];?>"><?php echo $rs->fields["cod_estab"];?></a></td>
                    <td class="raya"align="center"><a class="toolbar1" href="../estab/m_estab.php?var_aux_mod=<?php echo $rs->fields["id_estab"];?>"><?php echo $rs->fields["dir"];?></a></td>
                    <td class="raya" align="center"><a class="toolbar1" onMouseOver="return overlib('<?php echo "Organismo superior: ".$rs->fields["org_sup"]."<br>Contacto: ".$rs->fields["contacto"];?>', ABOVE, RIGHT);" onMouseOut="return nd();" href="m_estab.php?var_aux_mod=<?php echo $rs->fields["id_estab"];?>"><?php echo $rs->fields["estab"];?></a></td>
                    ...
                    <table width="100%" border="0"  cellpadding="0" cellspacing="0"class="menubar" id="toolbar"  >
                        <tr  > 
                          ...
                          <td width="33%" > <div align="center"><a class="toolbar2" href="../estab/n_estab.php"><img src="../../../imagenes/menu/add_section.png" alt="Nuevo" name="new" width="16" height="16" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="33%" > <div align="center"> <a  onClick="modif('m_estab.php');" class="toolbar2" href="#"> 
