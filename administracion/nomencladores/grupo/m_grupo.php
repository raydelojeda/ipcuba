	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              ...
              <table width="92%"  align="center"  class="tabla">
                ...
                <tr> 
                  <td align="right"> <div align="right">División:</div></td>
                  <td><div align="left"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                    <select name="sel_division" title="División" id="sel_division" >
                ...
                <tr> 
                  <td width="17%"> <div align="right">Código 
                      de grupo:</div></td>
                  <td width="83%"> <div align="left"> 
                      <input name="txt_cod_grupo" type="text"  class="combo" id="txt_cod_grupo" title="Código del grupo" value="<?php echo $rs->fields["cod_grupo"]; ?>" size="50">
                    </div></td>
                </tr>
                <tr> 
