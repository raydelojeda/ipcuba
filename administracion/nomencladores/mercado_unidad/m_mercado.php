...
include("../../../php/session/session_super.php");
	...
	if (isset($_POST['txt_mercado']))
	{
	  ...
	  {
	$sql = "UPDATE n_mercado SET  mercado = '".$_POST["txt_mercado"]."'WHERE mercado = '".$_POST["var_id"]."'";
	//print $sql;
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
            <form name="frm"  id="frm" method="post" action="" onSubmit="MM_validateForm('txt_cod_mercado','','R','txt_mercado','','RLetras');return document.MM_returnValue">
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
<tr>
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control 
                          del mercado: <font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_mercado_unidad.php"> 
                            ...
                            <br>
                    Cancelar</a> </div></td>
                <td width="6%"> <div align="center"><a class="toolbar" href="#" onclick="window.open('../../../help/m_mercado_unidad.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
...
<div align="center"></div></td>
                      ...
                      <tr> 
                        ...
                        <td width="56%"><div align="left"> 
                            <input name="txt_mercado"   title="Mercado" type="text" id="txt_mercado" value="<?php echo $rs->fields["mercado"]; ?>">
                          </div></td>
                      </tr>
                      <tr> 
...
<div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong></strong></font></div></td>
            ...
            </table><input  type="hidden" name="var_id" value="<?php echo $rs->fields["mercado"]?>">
              <p>&nbsp;</p></form>
