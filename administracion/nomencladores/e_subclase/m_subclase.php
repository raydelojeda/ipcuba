...
include($x."php/session/session_super.php");
	...
	if (isset($_POST['txt_cod_subclase']))
	{
	   ...
	   $txt_prov_mun=$_POST["txt_subclase"];
		 ...
		 // else
		//  {
		$sql = "UPDATE e_subclase SET  id_clase ='".$_POST["sel_clase"]."',cod_subclase ='".$_POST["txt_cod_subclase"]."',subclase = '".$_POST["txt_subclase"]."'WHERE ide_subclase = '".$_POST["var_id"]."'";
		//print $sql;
...
<div align="right">Código de la subclase:</div></td>
                ...
                <tr> 
                  ...
                  <td><div align="left"> 
                    ...
                    <input  type="hidden" name="var_id" value="<?php echo $rs->fields["ide_subclase"]?>"></td>
                </tr>
                <tr> 
