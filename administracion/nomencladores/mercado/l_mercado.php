...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="61%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Administración 
                            de mercado</font></strong></td>
                          <td width="0%"> <div align="center"><a class="toolbar" href="../mercado/n_mercado.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="6%"> <div align="center"> <a  onClick="modif('m_mercado.php');" class="toolbar" href="#"> 
                ...
                <br>
                <table width="64%"   align="center" cellpadding="0" cellspacing="0"  class="tabla" id="toolbar1">
<thead>
                    ...
                    <tr> 
                      ...
                      <td colspan="2"  align="center"  >Filtro: 
...
<select  onChange="document.frm.submit();" class="combo" name="sel_filtro">
                          ...
                          <option value="<?php echo "id_unidad" ?>"<?php if ($sel_filtro == "id_unidad") { echo "selected"; } ?>><?php echo htmlspecialchars("id unidad") ?></option>
                          <option value="<?php echo "unidad" ?>"<?php if ($sel_filtro == "unidad") { echo "selected"; } ?>><?php echo htmlspecialchars("unidad") ?></option>
                        </select>
                        &nbsp;</td>
                    </tr>
                    <tr> 
                    ...
                    <tr align="center" valign="center"  > 
                      <td class="intro" width="8%" height="21">No</td>
                      <td colspan="2" class="intro"> <div align="center"><a href="../mercado/l_mercado.php?order=<?php echo "mercado" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Mercado</a></div></td>
                      <td class="intro" width="6%">&nbsp; </td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
...
{	
  ...
  ?>
                    <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                      ...
                      <td class="raya" height="26"colspan="2" align="center"><a href="../mercado/m_mercado.php?var_aux_mod=<?php echo $rs->fields["id_mercado"];?>"> 
                        <?php echo $rs->fields["mercado"];?> </a> 
                        <div align="center"></div></td>
                      <td class="raya" height="26"align="center" valign="middle"> 
                        <input name="checkbox_<?php echo $rs->fields["id_mercado"];?>" type="checkbox"  value="checkbox">                      </td>
                    </tr>
                    <?php 
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "n_mercado";?>">
                  <input type="hidden" name="campo" value="<?php echo "id_mercado";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/nomencladores/mercado/l_mercado.php";?>">
                </p>
              </div>
              </form>
