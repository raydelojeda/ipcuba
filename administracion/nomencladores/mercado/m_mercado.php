...
include($x."php/session/session_super.php");
	...
	if (isset($_POST['txt_mercado']))
	{
	   ...
	   $txt_mercado=$_POST["txt_mercado"];
		 ...
		 // else
		//  {
		$sql = "UPDATE n_mercado  SET mercado = '".$_POST["txt_mercado"]."'  WHERE id_mercado = '".$_POST["var_id"]."'";
		//print $sql;
		$rs = $db->Execute($sql) or $mensaje=$db->ErrorMsg() ;
		//print $rs->Fields(0);
		if($rs)	
		header("Location: l_mercado.php");
		else
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
            <form name="frm"  id="frm" method="post" action="" onSubmit="MM_validateForm('txt_mercado','','R');return document.MM_returnValue">
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
<tr>
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control 
                          de  mercado: <font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="../mercado/l_mercado.php"> 
                            ...
                            <br>
                    Cancelar</a> </div></td>
                <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/m_mercado.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <table width="46%"  align="center"  class="tabla">
                ...
                <tr> 
                  ...
                  <td width="71%"><div align="left"> 
                      <input name="txt_mercado" type="text"  class="combo" id="txt_mercado" title="Mercado" value="<?php echo $rs->fields["mercado"]; ?>">
                      <input  type="hidden" name="var_id" value="<?php echo $rs->fields["id_mercado"]?>">
                  </div>                    </td>
                </tr>
                <tr> 
