...
//print $sql;
				 ...
				 $mensaje="La unidad ha sido insertada satisfactoriamente.";
			//	}
			//}			
			// else
			 //$mensaje="Ya existe una unidad en la BD.";
		//}
		//else
		//$mensaje="Ya existe un código de unidad en la BD.";
	 }	 
	else
                  ...
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control 
                          de la unidad: <font size="2">Insertar</font></font></strong> 
...
<table width="340" align="center" class="tabla">
                      ...
                      <tr align="center" > 
                        <td height="14"><div align="right">Unidad:</div></td>
                        <td height="14"><div align="left"> 
                            <input name="txt_unidad"  type="text" id="txt_unidad"  title="Unidad">
                          </div></td>
                      </tr>
                      <tr align="center" > 
