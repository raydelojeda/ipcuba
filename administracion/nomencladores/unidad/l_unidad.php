                    ...
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="61%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Administración 
                            de la unidad</font></strong></td>
                          <td width="0%"> <div align="center"><a class="toolbar" href="../unidad/n_unidad.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
...
<select  onChange="document.frm.submit();" class="combo" name="sel_filtro">
                    ...
                    <tr align="center" valign="center"  > 
                      ...
                      <td colspan="2" class="intro"> <div align="center"><a href="../unidad/l_unidad.php?order=<?php echo "unidad" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Unidad</a></div></td>
...
{	
  ...
  ?>
                    <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                      ...
                      <td class="raya" height="26"colspan="2" align="center"><a href="../unidad/m_unidad.php?var_aux_mod=<?php echo $rs->fields["id_unidad"];?>"> 
                        <?php echo $rs->fields["unidad"];?> </a> 
                        <div align="center"></div></td>
                      <td class="raya" height="26"align="center" valign="middle"> 
                        <input name="checkbox_<?php echo $rs->fields["id_unidad"];?>" type="checkbox"  value="checkbox">                      </td>
                    </tr>
                    <?php 

     if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["id_unidad"];
		       	 }
				 else
				 {
		            $cadenacheckboxp .= ",".$rs->fields["id_unidad"];
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "n_unidad";?>">
                  <input type="hidden" name="campo" value="<?php echo "id_unidad";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/nomencladores/unidad/l_unidad.php";?>">
                </p>
              </div>
              </form>
