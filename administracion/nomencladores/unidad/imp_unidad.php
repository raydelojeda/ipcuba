...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><strong>Unidad</strong></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
  	...
  	?> 
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td class="imp_celda"width="28%" >Código Unidad</td>
                    <td width="61%" class="imp_celda"> 
                      <div align="left">Unidad</div></td>
                  </tr>
                  <?php
 	if ($rs->RecordCount() > 0)
  	{
  ...
  ?>
                  <tr> 
                    ...
                    <td class="imp_celda" align="center"><?php echo $rs->fields["id_unidad"];?></td>
                    <td class="imp_celda"> <div align="left"><?php echo $rs->fields["unidad"];?></div></td>
                  </tr>
                  <?php 
