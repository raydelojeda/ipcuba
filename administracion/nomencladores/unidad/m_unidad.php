...
include($x."php/session/session_super.php");
	...
	if (isset($_POST['txt_unidad']))
	{
	   ...
	   $txt_unidad=$_POST["txt_unidad"];
		 ...
		 // else
		//  {
		$sql = "UPDATE n_unidad  SET unidad = '".$_POST["txt_unidad"]."'  WHERE id_unidad = '".$_POST["var_id"]."'";
		//print $sql;
		$rs = $db->Execute($sql) or $mensaje=$db->ErrorMsg() ;
		//print $rs->Fields(0);
		if($rs)	
		header("Location: l_unidad.php");
		else
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Control 
                          de la unidad: <font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="../unidad/l_unidad.php"> 
              ...
              <p>&nbsp;</p>     
              <table width="46%"  align="center"  class="tabla">
                
                <tr> 
                  <td width="29%" height="34"><div align="right">
                  <div align="right">Unidad:</div></td>
                  <td width="71%"><div align="left"> 
                      <input name="txt_unidad" type="text"  class="combo" id="txt_unidad" title="Unidad" value="<?php echo $rs->fields["unidad"]; ?>">
                      <input  type="hidden" name="var_id" value="<?php echo $rs->fields["id_unidad"]?>">
                  </div>                    </td>
                </tr>
                <tr> 
