...
include($x."php/session/session_super.php");
	...
	if (isset($_POST['txt_fecha']))
	{
		...
		{
		$sql = "UPDATE b_variedad SET  fecha ='".$_POST["txt_fecha"]."' WHERE idb_variedad = '".$_GET["var_aux_mod"]."'";
		//print $sql;
		$rs = $db->Execute($sql) or $mensaje=$db->ErrorMsg() ;
		//print $rs->Fields(0);
		if($rs)	
		header("Location: l_bvariedad.php?curr_page=".$curr_page."&regis_cant=".$regis_cant."");
		else
	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Variedades 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="../variedad/l_bvariedad.php?curr_page=<?php print $curr_page."&regis_cant=".$regis_cant;?>"> 
                  ...
                  <td colspan="2"> 
                    <div align="left">
                      <?php 
                     				$tabla=n_mercado;
									$campo=id_mercado;
									$valor=$rs->fields["id_mercado"];
									include($x."php/listar_simple.php");
									echo $rs_simple->fields["mercado"];
								    ?>
                    </div></td>
                </tr>
