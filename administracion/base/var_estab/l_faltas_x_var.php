...
$query = "select n_variedad.id_variedad, variedad, count (n_variedad.id_variedad) 
...
$query.= " group by n_variedad.id_variedad,variedad order by count (n_variedad.id_variedad) desc";
...
?>
          ...
          <tr> 
            <td align="center" valign="middle" bgcolor="#FFFFFF"> <div align="center"> 
                  ...
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar" id="toolbar"  >
                        <tr  > 
                          ...
                          <td width="82%" valign="middle"  class="us"><strong><font color="#5A697E" size="3">Faltas por variedad.</font></strong></td>
                ...
                <br>
                <table width="99%" height="93" border="0" cellpadding="0" cellspacing="0" class="tabla" id="toolbar1">
                  
                  <tr align="center" valign="center"  >
                    <td height="33" colspan="9" ><table width="747" height="32" border="0" cellpadding="0" cellspacing="0" class="filtro" >
                      <tr>
                        ...
                        <td width="78"><div align="right"> <a href="#">
                  ...
                  <tr align="center" valign="center"  >
                    ...
                    <td width="25%" height="20" class="intro">Variedad</td>
 ...
 if($mes!=0 and $ano!=0)
{
  ...
  if($mes!=0 and $ano!=0)
				  ...
				  from captacion,n_var_estab, b_variedad, n_variedad, n_estab,n_dpa
				  where n_var_estab.idb_variedad=b_variedad.idb_variedad 
				  and b_variedad.id_variedad=n_variedad.id_variedad 
...
$sql5 .= " and n_dpa.cod_dpa='".$sel_cod_dpa."'"; 
 ...
 ?>
                  ...
                  <tr <?php $a=$pager_nav->index_rs++;if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";?> >
                    ...
                    <td height="21" align="center" class="raya"><div align="left"><?php echo $rs->fields["variedad"];?></div></td>
