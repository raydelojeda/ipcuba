            ...
            <td align="center" valign="middle" bgcolor="#FFFFFF"> <div align="center"> 
                ...
                <table width="99%" height="102" border="0" cellpadding="0" cellspacing="0" class="tabla" id="toolbar1">
                  ...
                  <tr align="center" valign="center"  >
                    <td height="49" colspan="8" ><table width="747" height="40" border="0" cellpadding="0" cellspacing="0" class="filtro" >
                      <tr>
                  ...
                  <tr align="center" valign="center"  >
                    ...
                    <td class="intro" width="12%">Precios no observados por faltas</td>
                    <td class="intro" width="11%">Formal</td>
                    <td class="intro" width="12%">Informal</td>
                    <td class="intro" width="12%">Agropecuario</td>
                    <td class="intro" width="12%">Divisa</td>
                  </tr>
                  <?php
  $cadenacheckboxp = "";
 if($mes!=0 and $ano!=0)
{
  ...
  if($mes!=0 and $ano!=0)
				  ...
				  from captacion,n_var_estab, b_variedad, n_variedad, n_estab,n_dpa, e_articulo, n_mercado 
