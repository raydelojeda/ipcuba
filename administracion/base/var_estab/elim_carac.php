 ...
 if(!empty($_POST)){ // con esto evito el intento de acceder directamente a esta pagina escribiendo su URL en el browser
	...
	if(count($var) != 0)
  {
	...
	$query_rs_delete= "UPDATE $tabla 
			SET cantidad=null, id_unidad='22',valor1=null,valor2=null,valor3=null,valor4=null,valor5=null,valor6=null WHERE $campo='".$Id."'";
	  
	  $rs_delete = $db->Execute($query_rs_delete) or die($db->ErrorMsg()."Consulte a su Administrador. Dé click en el botón <- Atrás del navegador.");//print $a;print $query_rs_delete;	
	  if($rs_delete)
		{
