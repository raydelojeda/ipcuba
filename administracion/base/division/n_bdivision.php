...
//---------------------------------------------------					 
$sql_fecha = "select max(fecha) from b_division";		
...
{	
	...
	$sel_mercado_nuevo = $db->qstr($_POST['sel_mercado_nuevo'], $magic_quotes);	
	
	$txt_pond_r= $db->qstr($_POST['txt_pond_r'], $magic_quotes);
	$txt_fecha = $db->qstr($_POST['txt_fecha'], $magic_quotes);
	//print $sel_cod_art;print $sel_mercado_nuevo;print $txt_valor;
	
	if($txt_pond_r!='') 
	{		
				
 				$sql_upd_art = "UPDATE b_division SET r_peso =$txt_pond_r WHERE id_division = $sel_cod_art and id_mercado_nuevo = $sel_mercado_nuevo";//print $sql_upd_art;
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
               <form action="" method="post" name="frm" onSubmit="MM_validateForm('sel_division','','Escoger','sel_mercado_nuevo','','Escoger','sel_unidad','','Escoger','txt_fecha','','R','txt_precio','','RisNum','txt_precio_min','','RisNum','txt_precio_max','','RisNum');return document.MM_returnValue">
              <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por division y moneda: <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="9%"> 
                          <div align="center"> <a class="toolbar" href="l_bdivision.php"> 
                            <img name="imageField2" src="../../../imagenes/admin/cancel_f2.png" alt="Cerrar" width="32" height="32" border="0"> 
                            <br>
                            Cancelar</a> </div></td>
                        <td width="7%"> 
                          <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/n_bdivision.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <table  class="tabla" width="98%" align="center">
                ...
                <tr> 
                  ...
                  <td><div align="left">
                      <select name="sel_mercado_nuevo" title="Mercado" id="select" onChange="document.frm.submit();" >
                        <option value="0">-----------------------</option>
                        <?php 
                     				$x="../";
									
									$id=$_POST['sel_mercado_nuevo'];
									
									$query_sel = "select distinct mercado_nuevo, n_mercado.id_mercado_nuevo from b_division, n_mercado where n_mercado.id_mercado_nuevo=b_division.id_mercado_nuevo AND fecha='".$fecha_base."'";
                ...
                <tr> 
                  ...
                  <td width="76%"> <div align="left">
                      <select name="sel_cod_art" title="Código Artículo" id="sel_cod_art" >
                        <option value="0">-----------------------</option>
                        <?php 
						//print $_POST['sel_mercado_nuevo'];
						if($_POST['sel_mercado_nuevo']!="0" && $_POST['sel_mercado_nuevo']!="")
						{
                    	 $query_sel = "select n_division.id_division, n_division.cod_division, n_division.division from n_division, b_division WHERE n_division.id_division=b_division.id_division and b_division.id_mercado_nuevo='".$_POST['sel_mercado_nuevo']."' AND fecha='".$fecha_base."' order by n_division.cod_division";
						 $rs_selected=$db->Execute($query_sel) or $mensaje=$db->ErrorMsg() ;
					     $cant_rs=$rs_selected->RecordCount();
 							for ($i = 0; $i < $cant_rs;$i++)
							{
							$rs_fields0=$rs_selected->Fields("division");
							$rs_fields1=$rs_selected->Fields("cod_division");
							$rs_fields_id=$rs_selected->Fields("id_division");
