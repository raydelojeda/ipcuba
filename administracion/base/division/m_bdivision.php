...
include($x."php/session/session_super.php");
	...
	$sel_cod_art = $rs->fields["id_division"];
	$sel_mercado_nuevo = $rs->fields["id_mercado_nuevo"];	
	...
	{	
				...
				if($rs)	
				header("Location: l_bdivision.php?curr_page=".$curr_page."&regis_cant=".$regis_cant."");
				else
	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por division y moneda:<font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_bdivision.php?curr_page= <?php print $current_page."&regis_cant=".$regis_cant;?>"> 
                            <img name="imageField2" src="../../../imagenes/admin/cancel_f2.png" alt="Cerrar" width="32" height="32" border="0"> 
                            <br>
                    Cancelar</a> </div></td>
                <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/m_bdivision.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
                  ...
                  <td width="62%"> 
                    <div align="left">
                      <?php 
                     				$tabla=n_division;
									$campo=id_division;
									$valor=$rs->fields["id_division"];
									include($x."php/listar_simple.php");
									echo $rs_simple->fields["cod_division"].". ".$rs_simple->fields["division"];
								    ?>
                    </div></td>
                </tr>
                <tr> 
