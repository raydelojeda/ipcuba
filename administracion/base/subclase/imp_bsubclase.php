...
$query = "select * from n_subclase, b_subclase, n_mercado where b_subclase.id_subclase=n_subclase.id_subclase and b_subclase.id_mercado_nuevo=n_mercado.id_mercado_nuevo and fecha='".$fecha_max."'";
