...
//---------------------------------------------------					 
$sql_fecha = "select max(fecha) from b_subclase";		
                ...
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por subclase y moneda: <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="9%"> 
                          <div align="center"> <a class="toolbar" href="l_bsubclase.php"> 
                  ...
                  <td><div align="left">
                      <select name="sel_mercado" title="Mercado" id="select" onChange="document.frm.submit();" >
                        ...
                        <?php 
									...
									$query_sel = "select distinct mercado_nuevo, n_mercado.id_mercado_nuevo from b_subclase, n_mercado where n_mercado.id_mercado_nuevo=b_subclase.id_mercado_nuevo AND fecha='".$fecha_base."'";
                ...
                <tr> 
                  ...
                  <td width="79%"> <div align="left">
                      <select name="sel_cod_art" title="Código Artículo" id="sel_cod_art" >
						...
						{
                    	 $query_sel = "select e_subclase.ide_subclase, e_subclase.cod_subclase, e_subclase.subclase from e_subclase, b_subclase WHERE e_subclase.ide_subclase=b_subclase.ide_subclase and b_subclase.id_mercado_nuevo='".$_POST['sel_mercado']."' AND fecha='".$fecha_base."' and e_subclase.ide_subclase!='1' order by e_subclase.cod_subclase";
						 $rs_selected=$db->Execute($query_sel) or $mensaje=$db->ErrorMsg() ;
					     $cant_rs=$rs_selected->RecordCount();
 							for ($i = 0; $i < $cant_rs;$i++)
							{
