...
$query = "select distinct idb_articulo, fecha, ecod_articulo, earticulo, mercado_nuevo, b_articulo.r_peso, b_articulo.g_peso from e_articulo, b_articulo, n_mercado where b_articulo.ide_articulo=e_articulo.ide_articulo and b_articulo.id_mercado_nuevo=n_mercado.id_mercado_nuevo and fecha='".$fecha_max."' and ide_subclase!='1'";
...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por art&iacute;culo y moneda.</font></strong></td>
                          <td width="0%"> <div align="center"><a class="toolbar" href="n_barticulo.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="4%"> <div align="center"> <a  onClick="modif('m_barticulo.php');" class="toolbar" href="#"> 
                            ...
                            <div align="center"> <a class="toolbar" href="#"> 
                              ...
                              <br>
                              Borrar</a> </div></td>
                          <td width="5%"> <div align="center"> <a  class="toolbar" href="imp_barticulo.php?no=<?php $b=$pager_nav->index_rs; echo $b; ?>%20" target="_blank" > 
...
<div align="right">
                  ...
                  <tr> 
                    ...
                    <td width="38%" align="left"><div align="right">
                        Filtro:     
                    ...
                    <td colspan="4" align="right"  ><?php print "Fecha Base :".$rs->fields["fecha"]." =100";?>&nbsp;</td>
                  </tr>
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="13%" class="intro" ><a href="l_barticulo.php?order=<?php echo "ecod_articulo";?>&type=<?php echo $ordtypestr;?>">Código 
                      Artículo </a></td>
                    <td class="intro"> <div align="center"><a href="l_barticulo.php?order=<?php echo "earticulo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Artículo</a></div></td>
                    <td width="15%" class="intro"> 
                    <div align="center"><a href="l_barticulo.php?order=<?php echo "mercado_nuevo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Moneda</a></div></td>
                    <td width="15%" class="intro"><a href="l_barticulo.php?order=<?php echo "r_peso" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Peso respecto al rubro</a></td>
                    <td width="13%" class="intro"><a href="l_barticulo.php?order=<?php echo "g_peso" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Peso respecto al total</a></td>
...
{	
  ...
  ?>
                  <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                    <td class="raya" height="22" align="center"> <a href="m_barticulo.php?var_aux_mod=<?php echo $rs->fields["idb_articulo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php $a=$pager_nav->index_rs++; echo $a; ?>
                      </a> </td>
                    <td class="raya" height="22" align="center"><a href="m_barticulo.php?var_aux_mod=<?php echo $rs->fields["idb_articulo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo $rs->fields["ecod_articulo"];?></a></td>
                    <td class="raya" height="22" align="center"><a href="m_barticulo.php?var_aux_mod=<?php echo $rs->fields["idb_articulo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1" onMouseOver="return overlib('<?php print "Fecha Base:".$rs->fields["fecha"]." = 100";?>', ABOVE, RIGHT);" onMouseOut="return nd();"> 
                      <?php echo $rs->fields["earticulo"];?></a></td>
                    <td class="raya" height="22" align="center"> <a href="m_barticulo.php?var_aux_mod=<?php echo $rs->fields["idb_articulo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo $rs->fields["mercado_nuevo"];?></a></td>
                    <td class="raya" align="center"><a href="m_barticulo.php?var_aux_mod=<?php echo $rs->fields["idb_articulo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo substr($rs->fields["r_peso"],0,6);?></a></td>
                    <td align="center" valign="middle" class="raya"><a href="m_barticulo.php?var_aux_mod=<?php echo $rs->fields["idb_articulo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo substr($rs->fields["g_peso"],0,6);?></a></td>
                    <td align="center" valign="middle" class="raya"> <input name="checkbox_<?php echo $rs->fields["idb_articulo"];?>" type="checkbox"  value="checkbox"></td>
                  </tr>
                  <?php 
					 
				  if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["idb_articulo"];
		       	 }
				  elseif($rs->fields["idb_articulo"]!='')
				 {
		            $cadenacheckboxp .= ",".$rs->fields["idb_articulo"];
		         }
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "b_articulo";?>">
                  <input type="hidden" name="campo" value="<?php echo "idb_articulo";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/base/articulo/l_barticulo.php";?>">
                </p>
              </div>
              </form>
