<?php 
$x="../../../";
$campo_order="n_articulo.cod_articulo";
...
$query = "select * from n_articulo, b_articulo, n_mercado where b_articulo.id_articulo=n_articulo.id_articulo and b_articulo.id_mercado_nuevo=n_mercado.id_mercado_nuevo and fecha='".$fecha_max."'";
...
<tr> 
  ...
  ?>
                  <tr> 
                    ...
                    <td class="imp_celda" align="center"><?php echo $rs->fields["cod_articulo"];?></td>
                    <td class="imp_celda"> <div align="left"><?php echo $rs->fields["articulo"];?></div></td>
