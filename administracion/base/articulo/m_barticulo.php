...
include($x."php/session/session_super.php");
	...
	{	
 				...
 				$sql_upd_art = "UPDATE b_articulo SET  r_peso =$txt_pond_r, g_peso =$txt_pond_g WHERE ide_articulo = $sel_cod_art and id_mercado_nuevo = $sel_mercado";
				$rs=$db->Execute($sql_upd_art) or die($db->ErrorMsg());
				if($rs)	
				header("Location: l_barticulo.php?curr_page=".$curr_page."&regis_cant=".$regis_cant."");
				else
...
?>
  ...
  <tr>
		  ...
		  setTimeout("document.frm.txt_pond_g.focus()",1);	
		</script> 
	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por art&iacute;culo y moneda:<font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_barticulo.php?curr_page= <?php print $current_page."&regis_cant=".$regis_cant;?>"> 
