...
$query = "select * from n_clase, b_clase, n_mercado where b_clase.id_clase=n_clase.id_clase and b_clase.id_mercado_nuevo=n_mercado.id_mercado_nuevo and fecha='".$fecha_max."'";
