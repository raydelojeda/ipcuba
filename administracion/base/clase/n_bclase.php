...
//---------------------------------------------------					 
$sql_fecha = "select max(fecha) from b_clase";		
...
{	
	...
	{		
 				...
 				$sql_upd_art = "UPDATE b_clase SET r_peso =$txt_pond_r WHERE id_clase = $sel_cod_art and id_mercado_nuevo = $sel_mercado";//print $sql_upd_art;
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
               <form action="" method="post" name="frm" onSubmit="MM_validateForm('sel_clase','','Escoger','sel_mercado','','Escoger','sel_unidad','','Escoger','txt_fecha','','R','txt_precio','','RisNum','txt_precio_min','','RisNum','txt_precio_max','','RisNum');return document.MM_returnValue">
              <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por clase y moneda: <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="9%"> 
                          <div align="center"> <a class="toolbar" href="l_bclase.php"> 
                            <img name="imageField2" src="../../../imagenes/admin/cancel_f2.png" alt="Cerrar" width="32" height="32" border="0"> 
                            <br>
                            Cancelar</a> </div></td>
                        <td width="7%"> 
                          <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/n_bclase.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <table  class="tabla" width="98%" align="center">
                ...
                <tr> 
                  <td height="22" align="right">Modena</td>
                  <td><div align="left">
                      <select name="sel_mercado" title="Mercado" id="select" onChange="document.frm.submit();" >
                        ...
                        <?php 
									...
									$query_sel = "select distinct mercado_nuevo, n_mercado.id_mercado_nuevo from b_clase, n_mercado where n_mercado.id_mercado_nuevo=b_clase.id_mercado_nuevo AND fecha='".$fecha_base."'";
                ...
                <tr> 
                  ...
                  <td width="79%"> <div align="left">
                      <select name="sel_cod_art" title="Código Artículo" id="sel_cod_art" >
						...
						{
                    	 $query_sel = "select n_clase.id_clase, n_clase.cod_clase, n_clase.clase from n_clase, b_clase WHERE n_clase.id_clase=b_clase.id_clase and b_clase.id_mercado_nuevo='".$_POST['sel_mercado']."' AND fecha='".$fecha_base."' order by n_clase.cod_clase";
						 $rs_selected=$db->Execute($query_sel) or $mensaje=$db->ErrorMsg() ;
					     $cant_rs=$rs_selected->RecordCount();
 							for ($i = 0; $i < $cant_rs;$i++)
							{
							$rs_fields0=$rs_selected->Fields("clase");
							$rs_fields1=$rs_selected->Fields("cod_clase");
							$rs_fields_id=$rs_selected->Fields("id_clase");
