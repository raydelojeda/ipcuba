...
$query = "select distinct idb_clase, fecha, cod_clase, clase, mercado_nuevo, b_clase.r_peso from n_clase, b_clase, n_mercado where b_clase.id_clase=n_clase.id_clase and b_clase.id_mercado_nuevo=n_mercado.id_mercado_nuevo and fecha='".$fecha_max."'";
...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por clase y moneda.</font></strong></td>
                          <td width="0%"> <div align="center"><a class="toolbar" href="n_bclase.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="4%"> <div align="center"> <a  onClick="modif('m_bclase.php');" class="toolbar" href="#"> 
                            ...
                            <div align="center"> <a class="toolbar" href="#"> 
                              ...
                              <br>
                              Borrar</a> </div></td>
                          <td width="5%"> <div align="center"> <a  class="toolbar" href="imp_bclase.php?no=<?php $b=$pager_nav->index_rs; echo $b; ?>%20" target="_blank" > 
                              <img   src="../../../imagenes/admin/print.png" alt="Imprimir" width="32" height="32" border="0"> 
                              <br>
                              Imprimir</a> </div></td>
                          <td width="10%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/l_bclase.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
...
<div align="right">
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="15%" class="intro" ><a href="l_bclase.php?order=<?php echo "cod_clase";?>&type=<?php echo $ordtypestr;?>">Código 
                      Clase </a></td>
                    <td class="intro"> <div align="center"><a href="l_bclase.php?order=<?php echo "clase" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Clase</a></div></td>
                    <td width="17%" class="intro"> 
                    <div align="center"><a href="l_bclase.php?order=<?php echo "mercado_nuevo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Moneda</a></div></td>
                    <td width="20%" class="intro"><a href="l_bclase.php?order=<?php echo "r_peso" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Peso respecto al rubro</a></td>
...
{	
  ...
  ?>
                  <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                    <td class="raya" height="22" align="center"> <a href="m_bclase.php?var_aux_mod=<?php echo $rs->fields["idb_clase"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php $a=$pager_nav->index_rs++; echo $a; ?>
                      </a> </td>
                    <td class="raya" height="22" align="center"><a href="m_bclase.php?var_aux_mod=<?php echo $rs->fields["idb_clase"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo $rs->fields["cod_clase"];?></a></td>
                    <td class="raya" height="22" align="center"><a href="m_bclase.php?var_aux_mod=<?php echo $rs->fields["idb_clase"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1" onMouseOver="return overlib('<?php print "Fecha Base:".$rs->fields["fecha"]." = 100";?>', ABOVE, RIGHT);" onMouseOut="return nd();"> 
                      <?php echo $rs->fields["clase"];?></a></td>
                    <td class="raya" height="22" align="center"> <a href="m_bclase.php?var_aux_mod=<?php echo $rs->fields["idb_clase"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo $rs->fields["mercado_nuevo"];?></a></td>
                    <td class="raya" align="center"><a href="m_bclase.php?var_aux_mod=<?php echo $rs->fields["idb_clase"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo substr($rs->fields["r_peso"],0,6);?></a></td>
                    <td align="center" valign="middle" class="raya"> <input name="checkbox_<?php echo $rs->fields["idb_clase"];?>" type="checkbox"  value="checkbox"></td>
                  </tr>
                  <?php 
					 
				  if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["idb_clase"];
		       	 }
				  elseif($rs->fields["idb_clase"]!='')
				 {
		            $cadenacheckboxp .= ",".$rs->fields["idb_clase"];
		         }
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "b_clase";?>">
                  <input type="hidden" name="campo" value="<?php echo "idb_clase";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/base/clase/l_bclase.php";?>">
                </p>
              </div>
              </form>
