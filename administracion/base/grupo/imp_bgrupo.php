...
$query = "select * from n_grupo, b_grupo, n_mercado where b_grupo.id_grupo=n_grupo.id_grupo and b_grupo.id_mercado_nuevo=n_mercado.id_mercado_nuevo and fecha='".$fecha_max."'";
