...
$query = "select distinct idb_grupo, fecha, cod_grupo, grupo, mercado_nuevo, b_grupo.r_peso from n_grupo, b_grupo, n_mercado where b_grupo.id_grupo=n_grupo.id_grupo and b_grupo.id_mercado_nuevo=n_mercado.id_mercado_nuevo and fecha='".$fecha_max."'";
...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por grupo y moneda.</font></strong></td>
                          <td width="0%"> <div align="center"><a class="toolbar" href="n_bgrupo.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="4%"> <div align="center"> <a  onClick="modif('m_bgrupo.php');" class="toolbar" href="#"> 
                            ...
                            <div align="center"> <a class="toolbar" href="#"> 
                              ...
                              <br>
                              Borrar</a> </div></td>
                          <td width="5%"> <div align="center"> <a  class="toolbar" href="imp_bgrupo.php?no=<?php $b=$pager_nav->index_rs; echo $b; ?>%20" target="_blank" > 
                              <img   src="../../../imagenes/admin/print.png" alt="Imprimir" width="32" height="32" border="0"> 
                              <br>
                              Imprimir</a> </div></td>
                          <td width="10%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/l_bgrupo.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
...
<div align="right">
                  ...
                  <tr> 
                    ...
                    <td width="39%" align="left"><div align="right">
                        ...
                        <select  onChange="document.frm.submit();" class="combo" name="sel_filtro">
                          ...
                          <option value="<?php echo "cod_grupo" ?>"<?php if ($sel_filtro == "cod_grupo") { echo "selected"; } ?>><?php echo htmlspecialchars("Código Grupo") ?></option>
                          <option value="<?php echo "grupo" ?>"<?php if ($sel_filtro == "grupo") { echo "selected"; } ?>><?php echo htmlspecialchars("Grupo") ?></option>
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="15%" class="intro" ><a href="l_bgrupo.php?order=<?php echo "cod_grupo";?>&type=<?php echo $ordtypestr;?>">Código 
                      Grupo </a></td>
                    <td class="intro"> <div align="center"><a href="l_bgrupo.php?order=<?php echo "grupo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Grupo</a></div></td>
                    <td width="17%" class="intro"> 
                    <div align="center"><a href="l_bgrupo.php?order=<?php echo "mercado_nuevo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Moneda</a></div></td>
                    <td width="20%" class="intro"><a href="l_bgrupo.php?order=<?php echo "r_peso" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Peso respecto al rubro</a></td>
...
{	
  ...
  ?>
                  <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                    <td class="raya" height="22" align="center"> <a href="m_bgrupo.php?var_aux_mod=<?php echo $rs->fields["idb_grupo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php $a=$pager_nav->index_rs++; echo $a; ?>
                      </a> </td>
                    <td class="raya" height="22" align="center"><a href="m_bgrupo.php?var_aux_mod=<?php echo $rs->fields["idb_grupo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo $rs->fields["cod_grupo"];?></a></td>
                    <td class="raya" height="22" align="center"><a href="m_bgrupo.php?var_aux_mod=<?php echo $rs->fields["idb_grupo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1" onMouseOver="return overlib('<?php print "Fecha Base:".$rs->fields["fecha"]." = 100";?>', ABOVE, RIGHT);" onMouseOut="return nd();"> 
                      <?php echo $rs->fields["grupo"];?></a></td>
                    <td class="raya" height="22" align="center"> <a href="m_bgrupo.php?var_aux_mod=<?php echo $rs->fields["idb_grupo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo $rs->fields["mercado_nuevo"];?></a></td>
                    <td class="raya" align="center"><a href="m_bgrupo.php?var_aux_mod=<?php echo $rs->fields["idb_grupo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> 
                      <?php echo substr($rs->fields["r_peso"],0,6);?></a></td>
                    <td align="center" valign="middle" class="raya"> <input name="checkbox_<?php echo $rs->fields["idb_grupo"];?>" type="checkbox"  value="checkbox"></td>
                  </tr>
                  <?php 
					 
				  if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["idb_grupo"];
		       	 }
				  elseif($rs->fields["idb_grupo"]!='')
				 {
		            $cadenacheckboxp .= ",".$rs->fields["idb_grupo"];
		         }
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "b_grupo";?>">
                  <input type="hidden" name="campo" value="<?php echo "idb_grupo";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/base/grupo/l_bgrupo.php";?>">
                </p>
              </div>
              </form>
