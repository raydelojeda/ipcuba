...
include($x."php/session/session_super.php");
	...
	$sel_cod_art = $rs->fields["id_grupo"];
	...
	{	
				...
				if($rs)	
				header("Location: l_bgrupo.php?curr_page=".$curr_page."&regis_cant=".$regis_cant."");
				else
	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por grupo y moneda:<font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_bgrupo.php?curr_page= <?php print $current_page."&regis_cant=".$regis_cant;?>"> 
