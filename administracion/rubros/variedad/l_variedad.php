...
if($_POST['txt_ir'])
{//print "sds";
header("Location:l_variedad.php?curr_page=".$_POST['txt_ir']);
}
...
$query = "select * from g_variedad, n_variedad WHERE n_variedad.id_variedad = g_variedad.id_variedad AND fecha='".$fecha_base."'";
//print $query;
...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="2">Pesos por variedad para casos especiales.</font></strong></td>
                          <td width="0%"> 
                            <div align="center"><a class="toolbar" href="n_variedad.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="4%"> 
                            <div align="center"> <a  onClick="modif('m_variedad.php');" class="toolbar" href="#"> 
                          ...
                          <td width="4%"> 
                            <div align="center"> <a class="toolbar" href="#"> 
                              ...
                              Borrar</a> </div></td>
                          <td width="5%"> 
                            <div align="center"> <a  class="toolbar" href="imp_variedad.php?no=<?php $b=$pager_nav->index_rs; echo $b; ?> " target="_blank" > 
                ...
                <table width="99%" height="60"  align="center" cellpadding="0" cellspacing="0"  class="tabla"  id="toolbar1">
                  ...
                  <tr> 
                    ...
                    <?php print "<br>".$fecha_base." = 100";?>                    </div></td>
                  </tr>
                  <tr> 
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td  class="intro" ><a href="../../Copy of base/variedad/l_variedad.php?order=<?php echo "indice" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">-</a></td>
                    <td  class="intro" ><a href="../../Copy of base/variedad/l_variedad.php?order=<?php echo "central" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">- 
                      </a></td>
                    <td  class="intro" ><a href="../../Copy of base/variedad/l_variedad.php?order=<?php echo "mercado" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Peso</a></td>
                    <td class="intro"> <a href="../../Copy of base/variedad/l_variedad.php?order=<?php echo "variedad" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Variedad</a></td>
                    <td class="intro">&nbsp;</td>
                  </tr>
                  <?php
if($rs->fields[0]!='')
{	
  ...
  ?>
                  <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                    <td class="raya"height="22" align="center"><a href="m_variedad.php?var_aux_mod=<?php echo $rs->fields["idg_variedad"];?>&curr_page=<?php print $pager_nav->curr_page;?>&curr_page=<?php print $var;?>"  class="toolbar1"> 
                    ...
                    <td  class="raya" align="center">
                      ...
                      <a onMouseOver="return overlib('<?php echo "Variedad Centralizada Provincialmente.";?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1"href="m_variedad.php?var_aux_mod=<?php echo $rs->fields["idg_variedad"];?>"><img border="0" src="../../../imagenes/menu/hmenu-lock.png"></a>
                      <?php }elseif($central==1) {?>
					  <a onMouseOver="return overlib('<?php echo "Variedad Centralizada Nacionalmente.";?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1"href="m_variedad.php?var_aux_mod=<?php echo $rs->fields["idg_variedad"];?>"><img border="0" src="../../../imagenes/menu/hmenu-lock.png"></a>
                     <?php } elseif($central==0) {?>
					  <a onMouseOver="return overlib('<?php echo "Variedad No Centralizada.";?>', ABOVE, RIGHT);" onMouseOut="return nd();" class="toolbar1"href="../../Copy of base/variedad/m_variedad.php?var_aux_mod=<?php echo $rs->fields["idg_variedad"];?>"><img border="0" src="../../../imagenes/menu/hmenu-unlock.png"></a><?php } ?>                    </td>
                    <td class="raya"  ><div align="center"><a href="m_variedad.php?var_aux_mod=<?php echo $rs->fields["idg_variedad"];?>&curr_page=<?php print $pager_nav->curr_page;?>&curr_page=<?php print $var;?>"  class="toolbar1"> <?php echo $rs->fields["r_peso"];?></a></div></td>
                   <td class="raya" align="center"><a href="m_variedad.php?var_aux_mod=<?php echo $rs->fields["idg_variedad"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1" onMouseOver="return overlib('<?php echo "Código: ".$rs->fields["cod_var"];if($rs->fields["indice"]==1)print "<br>"."Variedad de la lista de bienes y servicios del IPC."; else print "<br>Variedad de la lista de bienes y servicios del PCI."; print "<br>Fecha Base:".$fecha_max." = 100";?>', ABOVE, RIGHT);" onMouseOut="return nd();"><?php echo $rs->fields["variedad"];?></a></td>
                    <td class="raya" align="center" valign="middle"> <input name="checkbox_<?php echo $rs->fields["idg_variedad"];?>" type="checkbox"  value="checkbox">                    </td>
                  </tr>
                  <?php 
					
     if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["idg_variedad"];
		       	 }
				  elseif($rs->fields["idg_variedad"]!='')
				 {
		            $cadenacheckboxp .= ",".$rs->fields["idg_variedad"];
		         }
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "g_variedad";?>">
                  <input type="hidden" name="campo" value="<?php echo "idg_variedad";?>">
					  <input type="hidden" name="location" value="<?php echo "../administracion/rubros/variedad/l_variedad.php";?>">
                </p>
              </div>
              </form>
