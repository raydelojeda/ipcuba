...
$query = "select * from g_variedad, n_variedad, n_mercado, n_unidad WHERE  n_mercado.id_mercado = g_variedad.id_mercado and  n_variedad.id_variedad = g_variedad.id_producto AND n_unidad.id_unidad = g_variedad.id_unidad AND fecha='".$fecha_base."'";
