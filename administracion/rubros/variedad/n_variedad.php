...
{	
	...
	{	
		//---------------------------------------------------
		$query = " where id_variedad = $sel_cod_var and fecha=$txt_fecha"; 
		$sql = "select idg_variedad from g_variedad".$query;		
		...
		//---------------------------------------------------		
			...
			//print $txt_precio_max.">=".$txt_precio_min. "&&" .$txt_precio_max.">=".$txt_precio. "&&" .$txt_precio.">=".$txt_precio_min;
 				 ...
 				 $sql="INSERT INTO g_variedad (r_peso,id_variedad,fecha) 
				 VALUES ($txt_pond_r,$sel_cod_var,$txt_fecha)";
				 $rs=$db->Execute($sql) or $mensaje=$db->ErrorMsg() ;
				//print $sql;
			...
			{
				$sql_upd_var = "UPDATE g_variedad SET r_peso =$txt_pond_r WHERE id_variedad = $sel_cod_var and fecha=$txt_fecha";
				//print $sql_upd_var;
				$db->Execute($sql_upd_var) or die($db->ErrorMsg());
				$mensaje="Los datos han sido insertados satisfactoriamente.";
			}
                ...
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td width="9%"> 
                          <div align="center"> <a class="toolbar" href="l_variedad.php"> 
                  ...
                  <td width="74%"> 
                    <div align="left">
                      <select name="sel_variedad" title="variedad" id="sel_variedad" >
                        ...
                        <?php 
                     				$tabla="n_variedad where ide_articulo!='1'";
									$campo0="variedad";
									$campo1="ecod_var";//
									$value=id_variedad;
