...
include($x."php/session/session_super.php");
	...
	$sel_cod_sub = $rs->fields["ide_subclase"];
	...
	{	
 				...
 				$sql_upd_art = "UPDATE g_subclase SET  r_peso =$txt_pond_r WHERE ide_subclase = $sel_cod_sub and fecha = $txt_fecha";
				$rs=$db->Execute($sql_upd_art) or die($db->ErrorMsg());
				if($rs)	
				header("Location: l_subclase.php?curr_page=".$curr_page."&regis_cant=".$regis_cant."");
				else
	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Peso por subclase :<font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_subclase.php?curr_page= <?php print $current_page."&regis_cant=".$regis_cant;?>"> 
