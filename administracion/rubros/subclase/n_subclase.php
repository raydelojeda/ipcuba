...
{	
	...
	$sel_cod_sub = $db->qstr($_POST['sel_cod_sub'], $magic_quotes);
	...
	if($sel_cod_sub!='' && $txt_pond_r!='') 
	{	
				
 				$sql_upd_sub = "UPDATE g_subclase SET r_peso =$txt_pond_r WHERE ide_subclase = $sel_cod_sub and fecha = $txt_fecha";
				//print $sql_upd_sub;
				$db->Execute($sql_upd_sub) or die($db->ErrorMsg());
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
               <form action="" method="post" name="frm" onSubmit="MM_validateForm('sel_subclase','','Escoger','sel_mercado','','Escoger','sel_unidad','','Escoger','txt_fecha','','R','txt_precio','','RisNum','txt_precio_min','','RisNum','txt_precio_max','','RisNum');return document.MM_returnValue">
              <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Peso por subclase : <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="9%"> 
                          <div align="center"> <a class="toolbar" href="l_subclase.php"> 
                            <img name="imageField2" src="../../../imagenes/admin/cancel_f2.png" alt="Cerrar" width="32" height="32" border="0"> 
                            <br>
                            Cancelar</a> </div></td>
                        <td width="7%"> 
                          <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/n_bsubclase.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <table  class="tabla" width="100%" align="center">
                ...
                <tr> 
                  ...
                  <td width="77%"> <div align="left">
                      <select name="sel_cod_sub" title="Código Subclase" id="sel_cod_sub" >
                        <option value="0">-----------------------</option>
                        <?php 
						//print $_POST['sel_mercado'];
						
                    	 $query_sel = "select e_subclase.ide_subclase, cod_subclase, subclase from e_subclase, g_subclase where g_subclase.ide_subclase=e_subclase.ide_subclase and e_subclase.ide_subclase!='1' order by cod_subclase";
						 $rs_selected=$db->Execute($query_sel) or $mensaje=$db->ErrorMsg() ;
					     $cant_rs=$rs_selected->RecordCount();
 							for ($i = 0; $i < $cant_rs;$i++)
							{
							$rs_fields0=$rs_selected->Fields("subclase");
							$rs_fields1=$rs_selected->Fields("cod_subclase");
							$rs_fields_id=$rs_selected->Fields("ide_subclase");
