<?php 
$x="../../../";
$campo_order="n_subclase.cod_subclase";
...
$query = "select * from n_subclase, g_subclase, n_mercado where g_subclase.id_subclase=n_subclase.id_subclase and g_subclase.id_mercado=n_mercado.id_mercado and fecha='".$fecha_max."'";
...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><strong>Subclases 
  	...
  	?><div align="right">
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td class="imp_celda"width="16%" >Código Subclase</td>
                    <td width="30%" class="imp_celda"> 
                      <div align="left">Subclase</div></td>
                    <td width="15%" class="imp_celda">Mercado</td>
                    <td width="12%" class="imp_celda">Valor</td>
                    <td width="12%" class="imp_celda">Fecha</td>
                    <td width="11%" class="imp_celda">Peso</td>
                  </tr>
                  <?php
 	if ($rs->RecordCount() > 0)
  	{
  ...
  ?>
                  <tr> 
                    ...
                    <td class="imp_celda" align="center"><?php echo $rs->fields["cod_subclase"];?></td>
                    <td class="imp_celda"> <div align="left"><?php echo $rs->fields["subclase"];?></div></td>
