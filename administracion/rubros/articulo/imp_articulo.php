...
$query = "select * from n_articulo, g_articulo, n_mercado where g_articulo.id_articulo=n_articulo.id_articulo and g_articulo.id_mercado=n_mercado.id_mercado and fecha='".$fecha_max."'";
