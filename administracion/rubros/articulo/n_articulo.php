...
//if($_POST['sel_cod_art']!='' && $_POST['txt_pond']!='') 
...
{	
	...
	if($sel_cod_art!='' && $txt_pond_g!='' && $txt_pond_r!='') 
	{	
				
 				$sql_upd_art = "UPDATE g_articulo SET  g_peso =$txt_pond_g, r_peso =$txt_pond_r WHERE ide_articulo = $sel_cod_art";
				//print $sql_upd_art;
              ...
              <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        <td width="4%" valign="middle"  class="us"><img src="../../../imagenes/large/folder_blue.gif" width="48" height="48" border="0"><strong><font color="#000000" size="1"> 
                          </font></strong></td>
                        <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Peso por art&iacute;culo : <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="9%"> 
                          <div align="center"> <a class="toolbar" href="l_articulo.php"> 
                  ...
                  <td width="75%"> <div align="left">
                      <select name="sel_cod_art" title="Código Artículo" id="sel_cod_art" >
						...
						//print $_POST['sel_mercado'];
                    	 ...
                    	 $query_sel = "select e_articulo.ide_articulo, ecod_articulo, earticulo from e_articulo, g_articulo where g_articulo.ide_articulo=e_articulo.ide_articulo and e_articulo.ide_articulo!='1' order by ecod_articulo";
