...
include($x."php/session/session_super.php");
	...
	$sel_cod_art = $rs->fields["ide_articulo"];
	...
	{	
 				...
 				$sql_upd_art = "UPDATE g_articulo SET  r_peso =$txt_pond_r, g_peso =$txt_pond_g WHERE ide_articulo = $sel_cod_art and fecha = $txt_fecha";
...
?>
  ...
  <tr>
		  ...
		  setTimeout("document.frm.txt_valor.focus()",1);	
		</script> 
		    <form name="frm"  id="frm" method="post" action="" onSubmit="MM_validateForm('sel_unidad','','Escoger','txt_precio_min','','RisNum','txt_precio_max','','RisNum','txt_fecha','','R','txt_precio','','RisNum','txt_valor','','R');return document.MM_returnValue">
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
<tr>
	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Artículos 
                          del a&ntilde;o base:<font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_articulo.php?curr_page= <?php print $current_page."&regis_cant=".$regis_cant;?>"> 
                            ...
                            <br>
                    Cancelar</a> </div></td>
                <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/m_barticulo.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
              ...
              <p>&nbsp;</p>     
              <table width="78%"  align="center"  class="tabla">
                <tr> 
                  <td align="right">&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
                  ...
                  <td width="64%"> 
                    <div align="left">
                      <?php 
                     				$tabla=e_articulo;
									$campo=ide_articulo;
									$valor=$rs->fields["ide_articulo"];
									include($x."php/listar_simple.php");
									echo $rs_simple->fields["ecod_articulo"].". ".$rs_simple->fields["earticulo"];
								    ?>
                    </div></td>
                </tr>
                <tr>
                  ...
                  <td><div align="left">
                      <input  name="txt_pond_g" type="text" title="Peso" value="<?php print $rs->fields["g_peso"]?>"  id="txt_pond_g">
                    (*)</div></td>
                </tr>
                <tr>
