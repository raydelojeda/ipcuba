...
<div align="right">
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="15%" class="intro" ><a href="l_articulo.php?order=<?php echo "ecod_articulo";?>&type=<?php echo $ordtypestr;?>">Código 
                      Artículo </a></td>
                    <td class="intro"> <div align="center"><a href="l_articulo.php?order=<?php echo "earticulo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Artículo</a></div></td>
