...
{	
	...
	{	
 				...
 				$sql_upd_sub = "UPDATE g_grupo SET r_peso =$txt_pond_r WHERE id_grupo = $sel_cod_sub and fecha = $txt_fecha";
				//print $sql_upd_sub;
                ...
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Peso por grupo : <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="9%"> 
                          <div align="center"> <a class="toolbar" href="l_grupo.php"> 
              ...
              <table  class="tabla" width="100%" align="center">
                ...
                <tr> 
                  ...
                  <td width="76%"> <div align="left">
                      <select name="sel_cod_sub" title="Código grupo" id="sel_cod_sub" >
                        <option value="0">-----------------------</option>
                        <?php 
						//print $_POST['sel_mercado'];
						
                    	 $query_sel = "select n_grupo.id_grupo, cod_grupo, grupo from n_grupo, g_grupo where g_grupo.id_grupo=n_grupo.id_grupo order by cod_grupo";
