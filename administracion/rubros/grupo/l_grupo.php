...
$query = "select n_grupo.id_grupo, r_peso, grupo, cod_grupo from n_grupo, g_grupo where g_grupo.id_grupo=n_grupo.id_grupo and fecha='".$fecha_max."'";// print $query;
...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="81%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por grupo. </font></strong></td>
						  <td width="0%"> <div align="center"><a class="toolbar" href="n_grupo.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="4%"> <div align="center"> <a  onClick="modif('m_grupo.php');" class="toolbar" href="#"> 
                              <img   src="../../../imagenes/admin/edit_f2.png" alt="Editar" width="32" height="32" border="0"> 
                              <br>
                              Editar</a> </div></td>
                          <td width="5%"> <div align="center"> <a  class="toolbar" href="imp_grupo.php?no=<?php $b=$pager_nav->index_rs; echo $b; ?> " target="_blank" > 
...
<div align="right"><a href="#"><?php
                  ...
                  <tr> 
                    ...
                    <td width="17%" align="left"> <div align="right">Filtro:</div></td>
                    <td width="33%" align="left"> <input  name="txt_filtro" type="text" class="combo" value="<?php echo $txt_filtro ?>" size="15">
                      <select  onChange="document.frm.submit();" class="combo" name="sel_filtro">
                        ...
                        <option value="<?php echo "cod_grupo" ?>"<?php if ($sel_filtro == "cod_grupo") { echo "selected"; } ?>><?php echo htmlspecialchars("Código") ?></option>
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="20%" class="intro" ><a href="l_grupo.php?order=<?php echo "cod_grupo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Código</a></td>
                    <td colspan="2" class="intro"> <div align="center"><a href="l_grupo.php?order=<?php echo "grupo" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Grupo</a></div></td>
                    <td colspan="2" class="intro"> <div align="center"><a href="l_grupo.php?order=<?php echo "r_peso" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Peso</a></div></td>
                  </tr>
                  <?php
  $cadenacheckboxp = "";
  	if ($rs->RecordCount() > 0)
  ...
  ?>
                  <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                    ...
                    <td class="raya" height="22" align="center"><a href="m_grupo.php?var_aux_mod=<?php echo $rs->fields["id_grupo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> <?php echo $rs->fields["cod_grupo"];?></a></td>
                    <td class="raya" height="22" colspan="2" align="center"><a href="m_grupo.php?var_aux_mod=<?php echo $rs->fields["id_grupo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"><?php echo $rs->fields["grupo"];?></a></td>
                    <td class="raya" height="22" colspan="2" align="center"><a href="m_grupo.php?var_aux_mod=<?php echo $rs->fields["id_grupo"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"><?php echo substr($rs->fields["r_peso"],0,6);?></a></td>
                  </tr>
                  <?php 
				 
     if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["idg_grupo"];
		       	 }
				 else
				 {
		            $cadenacheckboxp .= ",".$rs->fields["idg_grupo"];
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "g_grupo";?>">
                  <input type="hidden" name="campo" value="<?php echo "idg_grupo";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/rubros/grupo/l_grupo.php";?>">
                </p>
              </div>
              </form>
