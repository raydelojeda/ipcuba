...
$query = "select * from n_grupo, g_grupo, n_mercado where g_grupo.id_grupo=n_grupo.id_grupo and g_grupo.id_mercado=n_mercado.id_mercado and fecha='".$fecha_max."'";
...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><strong>grupos 
  	...
  	?><div align="right">
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td class="imp_celda"width="16%" >Código grupo</td>
  ...
  ?>
                  <tr> 
                    ...
                    <td class="imp_celda" align="center"><?php echo $rs->fields["cod_grupo"];?></td>
                    <td class="imp_celda"> <div align="left"><?php echo $rs->fields["grupo"];?></div></td>
