...
include($x."php/session/session_super.php");
	...
	$sel_cod_sub = $rs->fields["id_clase"];
	...
	{	
 				...
 				$sql_upd_art = "UPDATE g_clase SET  r_peso =$txt_pond_r WHERE id_clase = $sel_cod_sub and fecha = $txt_fecha";
				$rs=$db->Execute($sql_upd_art) or die($db->ErrorMsg());
				if($rs)	
				header("Location: l_clase.php?curr_page=".$curr_page."&regis_cant=".$regis_cant."");
				else
	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Peso por clase :<font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_clase.php?curr_page= <?php print $current_page."&regis_cant=".$regis_cant;?>"> 
                            <img name="imageField2" src="../../../imagenes/admin/cancel_f2.png" alt="Cerrar" width="32" height="32" border="0"> 
                            <br>
                    Cancelar</a> </div></td>
                <td width="6%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/m_bclase.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
                  ...
                  <td width="64%"> 
                    <div align="left">
                      <?php 
                     				$tabla=n_clase;
									$campo=id_clase;
									$valor=$rs->fields["id_clase"];
									include($x."php/listar_simple.php");
									echo $rs_simple->fields["cod_clase"].". ".$rs_simple->fields["clase"];
								    ?>
                    </div></td>
                </tr>
