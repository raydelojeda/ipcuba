...
$query = "select * from n_clase, g_clase, n_mercado where g_clase.id_clase=n_clase.id_clase and g_clase.id_mercado=n_mercado.id_mercado and fecha='".$fecha_max."'";
...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><strong>clases 
  	...
  	?><div align="right">
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td class="imp_celda"width="16%" >Código clase</td>
                    <td width="30%" class="imp_celda"> 
                      <div align="left">clase</div></td>
  ...
  ?>
                  <tr> 
                    ...
                    <td class="imp_celda" align="center"><?php echo $rs->fields["cod_clase"];?></td>
                    <td class="imp_celda"> <div align="left"><?php echo $rs->fields["clase"];?></div></td>
