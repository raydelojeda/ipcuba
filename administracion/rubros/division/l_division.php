...
$query = "select n_division.id_division, r_peso, division, cod_division from n_division, g_division where g_division.id_division=n_division.id_division and fecha='".$fecha_max."'";// print $query;
...
<tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                        <tr > 
                          ...
                          <td width="81%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Pesos por division. </font></strong></td>
						  <td width="0%"> <div align="center"><a class="toolbar" href="n_division.php"><img src="../../../imagenes/admin/new_f2.png" alt="Nuevo" name="new" width="32" height="32" border="0" id="new"><br>
                              Nuevo</a></div></td>
                          <td width="4%"> <div align="center"> <a  onClick="modif('m_division.php');" class="toolbar" href="#"> 
                              <img   src="../../../imagenes/admin/edit_f2.png" alt="Editar" width="32" height="32" border="0"> 
                              <br>
                              Editar</a> </div></td>
                          <td width="5%"> <div align="center"> <a  class="toolbar" href="imp_division.php?no=<?php $b=$pager_nav->index_rs; echo $b; ?> " target="_blank" > 
                              <img   src="../../../imagenes/admin/print.png" alt="Imprimir" width="32" height="32" border="0"> 
                              <br>
                              Imprimir</a> </div></td>
                          <td width="8%"> <div align="center"><a class="toolbar" href="#" onClick="window.open('../../../help/l_division.htm', 'mambo_help_win', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');"> 
...
<div align="right"><a href="#"><?php
                  ...
                  <tr> 
                    ...
                    <td width="16%" align="left"> <div align="right">Filtro:</div></td>
                    <td width="36%" align="left"> <input  name="txt_filtro" type="text" class="combo" value="<?php echo $txt_filtro ?>" size="15">
                      <select  onChange="document.frm.submit();" class="combo" name="sel_filtro">
                        <option value="<?php echo "no" ?>">-Seleccionar-</option>
                        <option value="<?php echo "cod_division" ?>"<?php if ($sel_filtro == "cod_division") { echo "selected"; } ?>><?php echo htmlspecialchars("Código") ?></option>
                        <option value="<?php echo "division" ?>"<?php if ($sel_filtro == "division") { echo "selected"; } ?>><?php echo htmlspecialchars("division") ?></option>
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td width="21%" class="intro" ><a href="l_division.php?order=<?php echo "cod_division" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Código</a></td>
                    <td colspan="2" class="intro"> <div align="center"><a href="l_division.php?order=<?php echo "division" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Division</a></div></td>
                    <td colspan="2" class="intro"> <div align="center"><a href="l_division.php?order=<?php echo "r_peso" ?>&type=<?php echo $ordtypestr ?>&txt_filtro=<?php echo $txt_filtro?>&sel_filtro=<?php echo $sel_filtro?>&ver=<?php echo $ver?>">Peso</a></div></td>
                  </tr>
                  <?php
  $cadenacheckboxp = "";
  	if ($rs->RecordCount() > 0)
  ...
  ?>
                  <tr <?php if($a % 2) print "class=\"row1\""; else print "class=\"row0\"";   ?> > 
                    ...
                    <td class="raya" height="22" align="center"><a href="m_division.php?var_aux_mod=<?php echo $rs->fields["id_division"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"> <?php echo $rs->fields["cod_division"];?></a></td>
                    <td class="raya" height="22" colspan="2" align="center"><a href="m_division.php?var_aux_mod=<?php echo $rs->fields["id_division"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"><?php echo $rs->fields["division"];?></a></td>
                    <td class="raya" height="22" colspan="2" align="center"><a href="m_division.php?var_aux_mod=<?php echo $rs->fields["id_division"];?>&curr_page=<?php print $pager_nav->curr_page;?>&regis_cant=<?php print $var;?>"  class="toolbar1"><?php echo substr($rs->fields["r_peso"],0,6);?></a></td>
                  </tr>
                  <?php 
				 
     if($cadenacheckboxp == "")
				 {
		      	    $cadenacheckboxp = $rs->fields["idg_division"];
		       	 }
				 else
				 {
		            $cadenacheckboxp .= ",".$rs->fields["idg_division"];
  ...
  ?>
               ...
               <p>
                  ...
                  <input type="hidden" name="tabla" value="<?php echo "g_division";?>">
                  <input type="hidden" name="campo" value="<?php echo "idg_division";?>">
                  <input type="hidden" name="location" value="<?php echo "../administracion/rubros/division/l_division.php";?>">
                </p>
              </div>
              </form>
