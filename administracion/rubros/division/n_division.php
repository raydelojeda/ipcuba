...
{	
	...
	{	
 				...
 				$sql_upd_sub = "UPDATE g_division SET r_peso =$txt_pond_r WHERE id_division = $sel_cod_sub and fecha = $txt_fecha";
				//print $sql_upd_sub;
...
?>
  ...
  <tr>
          <td align="center" valign="middle" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" --> 
               <form action="" method="post" name="frm" onSubmit="MM_validateForm('sel_division','','Escoger','sel_mercado','','Escoger','sel_unidad','','Escoger','txt_fecha','','R','txt_precio','','RisNum','txt_precio_min','','RisNum','txt_precio_max','','RisNum');return document.MM_returnValue">
              <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                <tr> 
                  <td class="menudottedline" align="right"> <table width="100%" border="0" class="menubar"  id="toolbar">
                      <tr > 
                        ...
                        <td width="71%" valign="middle"  class="us"><strong><font color="#5A697E" size="4">Peso por divisi&oacute;n : <font size="2">Insertar</font></font></strong> 
                        ...
                        <td width="9%"> 
                          <div align="center"> <a class="toolbar" href="l_division.php"> 
              ...
              <table  class="tabla" width="100%" align="center">
                ...
                <tr> 
                  ...
                  <td width="76%"> <div align="left">
                      <select name="sel_cod_sub" title="Código division" id="sel_cod_sub" >
                        <option value="0">-----------------------</option>
                        <?php 
						//print $_POST['sel_mercado'];
						
                    	 $query_sel = "select n_division.id_division, cod_division, division from n_division, g_division where g_division.id_division=n_division.id_division order by cod_division";
