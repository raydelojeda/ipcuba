...
$query = "select * from n_division, g_division, n_mercado where g_division.id_division=n_division.id_division and g_division.id_mercado=n_mercado.id_mercado and fecha='".$fecha_max."'";
...
<tr> 
                ...
                <table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
                  <tr> 
                    <td class="menudottedline" align="right"> <table width="100%" border="0" >
                        <tr > 
                          <td valign="middle"  class="imprimir"><strong>divisions 
  	...
  	?><div align="right">
                  ...
                  <tr align="center" valign="center"  > 
                    ...
                    <td class="imp_celda"width="16%" >Código division</td>
