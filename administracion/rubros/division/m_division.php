...
include($x."php/session/session_super.php");
	...
	$sel_cod_sub = $rs->fields["id_division"];
	...
	{	
 				...
 				$sql_upd_art = "UPDATE g_division SET  r_peso =$txt_pond_r WHERE id_division = $sel_cod_sub and fecha = $txt_fecha";
				$rs=$db->Execute($sql_upd_art) or die($db->ErrorMsg());
				if($rs)	
				header("Location: l_division.php?curr_page=".$curr_page."&regis_cant=".$regis_cant."");
				else
...
?>
  ...
  <tr>
		  ...
		  setTimeout("document.frm.txt_pond_r.focus()",1);	
		    ...
		    <form name="frm"  id="frm" method="post" action="" onSubmit="MM_validateForm('txt_pond_r','','RisNum');return document.MM_returnValue">
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
<tr>
	...
	<td class="menudottedline" align="right">
			...
			<table width="100%" border="0" class="menubar"  id="toolbar">
              <tr > 
                        ...
                        <td valign="middle"  class="us"><strong><font color="#5A697E" size="4">Peso por divisi&oacute;n :<font size="2">Modificar</font></font></strong> 
                ...
                <td width="7%"> <div align="center"> <a class="toolbar" href="l_division.php?curr_page= <?php print $current_page."&regis_cant=".$regis_cant;?>"> 
