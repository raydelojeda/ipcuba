 ...
 for($i=0;$i<$cant_tabla;$i++)
  {
	...
	$rs_u = $db->Execute($update)or die($db->ErrorMsg()) ;
			...
			$estab="select * from n_estab where id_tipologia='".$id_tipologia."' and cod_dpa='$cod_dpa' and id_mercado='4' ";
			...
			if($id_tipologia=="0")
			  {
				...
				{
				print "<br>Entre al 2";
				$estab="select * from n_estab where id_tipologia='".$id_tipologia2."' and cod_dpa='$cod_dpa' and id_mercado='4' ";
	...
	{
	print "<br>Entre al 3";
	$estab3="select * from n_estab where id_tipologia='".$id_tipologia3."' and cod_dpa='$cod_dpa' and id_mercado='1' ";
	...
	if($cant_estab3==0)
	{
		...
		{		   
		 ...
		 {
		 print "<br>Entre al 4";
		 $estab4="select * from n_estab where id_tipologia='".$id_tipologia4."' and cod_dpa='$cod_dpa' and id_mercado='2' ";
