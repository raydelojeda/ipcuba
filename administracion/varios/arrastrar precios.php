...
$mer="select captacion.id_obs,variedad, cap_ant.fecha as f_ant,captacion.fecha as f_act, cap_ant.precio as p_ant, captacion.precio as p_act, cap_ant.id_cap as id_cap_ant, captacion.id_cap as id_cap_act 

from captacion as cap_ant, captacion, n_var_estab, b_variedad, n_variedad
where cap_ant.precio!='0' and captacion.precio='0' 
and cap_ant.fecha>='2010-06-01' and captacion.id_var_estab=cap_ant.id_var_estab
and cap_ant.fecha<'2010-12-01' 
and captacion.fecha>='2010-12-01' 
and captacion.fecha<'2011-01-05' 
and captacion.id_obs!='3'
...
$cant_mer=$rs_mer->RecordCount(); 
	...
	for($m=0;$m<$cant_mer;$m++)
	 {	$me=substr($rs_mer->Fields("mercado"),0,1);
	 	$id_cap_act=$rs_mer->Fields("id_cap_act");
		...
		//print $m;
			...
			$sql = "UPDATE captacion SET id_obs='6', precio ='".$p_ant."', cont_imp='1' WHERE id_cap = '".$id_cap_act."' and captacion.fecha>='2010-12-01' 
and captacion.fecha<'2011-01-05' ";
	print $sql."<br>";
