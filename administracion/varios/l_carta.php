...
<tr> 
                    <td height="56" align="right" class="menudottedline"><table width="99%" border="0" class="menubar"  id="toolbar">
                      <tr >
                        ...
                        <td width="85%" valign="middle"  class="us"><font color="#5A697E" size="4">Tipolog&iacute;a a visualizar</font></td>
                        <td width="8%"><div align="center"> <a class="toolbar" href="carta.php?tipologia=<?php print $_POST['sel_tipologia'];?>&mercado=<?php print $_POST['sel_mercado'];?>"  ><img name="ver" src="../../../imagenes/large/vcalendar.gif" alt="Ver formularios" width="48" height="48" border="0">
                          Modelo</a> </div></td>
                      </tr>
                    </table></td>
                  </tr>
                ...
                <br>
                <table  class="tabla" width="71%" align="center">
                  <tr>
                  ...
                  <tr align="center">
                    <td width="23%" align="right">Tipolog&iacute;a:</td>
                    <td width="77%" align="left"><div align="left">
                      <select name="sel_tipologia" title="Tipología" onChange="javascript:document.frm.submit();"id="sel_tipologia">
                        <option value="0">-----------------------</option>
                        <?php 
								if($_POST['sel_mercado']!=0)
								{
								$tabla="n_tipologia,n_estab,n_mercado where n_mercado.id_mercado=n_estab.id_mercado and n_tipologia.id_tipologia=n_estab.id_tipologia and n_mercado.id_mercado='".$_POST['sel_mercado']."'";
								}
								else
								{
								...
								$query_sel = "select distinct tipologia, n_tipologia.id_tipologia from $tabla order by $campo0";//print $query_sel;
