...
$sql_var = "select * from traer() AS (id_grupo integer, grupo character varying(70))";
$rs=$db->Execute($sql_var) or die($db->ErrorMsg());
$cant_estab=$rs->RecordCount();
//print $cant_estab;
for($i=1;$i<=$cant_estab;$i++)
{
//print $rs->fields['id_grupo']."<br>";
print $rs->fields['grupo']."  ".$cant=$cant+1 ."<br>";
$rs->MoveNext();
}
//print $rs;
